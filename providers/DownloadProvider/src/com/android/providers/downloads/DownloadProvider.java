    ...
    private final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void upgradeTo(SQLiteDatabase db, int version) {
            switch (version) {
                ...
                /// M: add to fix 811498. @{
                //if google update db version to 109, then replace with 110 and put it 
                //after google's case 109 block.
                case 109:
                    addColumn(db, DB_TABLE, Constants.SCAN_REQUEST_CALLED, "BOOLEAN NOT NULL DEFAULT 0");
                    break;
                /// @}
    ...
    private void checkFileUriDestination(ContentValues values) {
        ...
        try {
            ...
            if (!canonicalPath.startsWith(externalPath) && !canonicalPath.startsWith("/storage/sdcard1/")
                    && !canonicalPath.startsWith("/storage/sdcard2/")) {
