            ...
            if (localPath != null && localPath.length() != 0) {
                ...
                try {
                    ...
                    if (drmCursor != null && drmCursor.moveToFirst()) {
                        ...
                        drmMethod = drmCursor
                                .getInt(drmCursor
                                        .getColumnIndex(MediaStore.MediaColumns.DRM_METHOD));
                    } else {
                        if (mimeType.equalsIgnoreCase(OmaDrmStore.DrmObjectMime.MIME_DRM_CONTENT)) {
                            drmMethod = OmaDrmStore.DrmMethod.METHOD_SD;
                        } else {
                            drmMethod = -1;
                        }
                    }
