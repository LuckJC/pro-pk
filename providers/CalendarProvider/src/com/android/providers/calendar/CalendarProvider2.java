...
public class CalendarProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    private static final String[] SEARCH_COLUMNS = new String[] {
        ...
        /** M: only search title and description, and description will effect CTS test. */
    ...
    private Cursor queryInternal(Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            ...
            case SEARCH_SUGGESTIONS_SHORTCUT:
                ...
                String[] projectionShortcut = new String[] { Events._ID, Events.TITLE, Events.DESCRIPTION, Events.RRULE, };
                Cursor sourceCursor = qb.query(db, projectionShortcut, selection, selectionArgs, null, null,
                        null, null, null);
    ...
    private Cursor handleSearchSuggestionQuery(SQLiteDatabase db, SQLiteQueryBuilder qb, String query,
        ...
        String[] projection = new String[] { Events._ID, Events.TITLE, Events.DESCRIPTION, Events.RRULE, };
        String[] tokens = tokenizeSearchQuery(query);
        ...
        Cursor sourceCursor = qb.query(db, projection, selection, selectionArgs, groupby, searchWhere,
                sortBy, limit, null);
        constructSearchSuggesions(targetCursor, sourceCursor);
        sourceCursor.close();
        return targetCursor;
