...
public class MmsProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        // M: MoMS for controling database access ability
        setQueryPermission(SubPermissions.QUERY_MMS);
    ...
    public Cursor query(Uri uri, String[] projection,
        ...
        MmsLog.d(TAG, "query begin, uri = " + uri + ", selection = " + selection);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        MmsLog.d(TAG, "insert begin, uri = " + uri + ", values = " + values);
        ...
        MmsLog.d(TAG, "insert succeed, uri = " + res);
        return res;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        int match = sURLMatcher.match(uri);
        MmsLog.d(TAG, "delete begin, uri = " + uri + ", selection = " + selection);
        SQLiteDatabase db = mOpenHelper.getWritableDatabase();
        int deletedRows = 0;
        ...
        MmsLog.d(TAG, "delete end, affectedRows = " + deletedRows);
        return deletedRows;
    }
    ...
    static int deleteMessages(Context context, SQLiteDatabase db,
        ...
        if (pduCount > 100) {
            ...
            while (deleteCount > 0) {
                ...
                count += deleteCount;
                MmsLog.d(TAG, "deleteMessages, delete " + deleteCount + " pdu");
            }
        } else {
    ...
    public int update(Uri uri, ContentValues values,
        ...
        MmsLog.d(TAG, "update begin, uri = " + uri + ", values = " + values + ", selection = " + selection);
        boolean notify = false;
        String msgId = null;
        String table;
    ...
    private String transformSubjectByCharset(String sub, int charset) {
        ...
        try {
            ...
            MmsLog.e(TAG, "transformSubjectByCharset UnsupportedEncodingException");
            return sub;
        }
        return result;
    }
