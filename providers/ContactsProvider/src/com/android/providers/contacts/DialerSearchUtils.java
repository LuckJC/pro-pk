...
public class DialerSearchUtils {
    ...
    public static String stripSpecialCharInNumberForDialerSearch(String number) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (PhoneNumberUtils.isNonSeparator(c) || c == 'p' || c == 'w' || c == 'P' || c == 'W') {
                sb.append(c);
            } else if (c == ' ' || c == '-' || c == '(' || c == ')') {
    ...
    public static void updateDialerSearchAfterInsertedCalls(SQLiteDatabase db, ContentValues values, long id,
        ...
        try {
            ...
            long dataId = -1;
            long rawContactId = -1;
            boolean bSpecialNumber = (CallerInfo.UNKNOWN_NUMBER.equals(strInsNumber)
                    || CallerInfo.PRIVATE_NUMBER.equals(strInsNumber) || CallerInfo.PAYPHONE_NUMBER.equals(strInsNumber));
