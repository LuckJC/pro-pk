...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
     ...
     * 
     * M: Android database version 803 ==> MTK database version 850
     * MTK versions >= 850
     * @{
     */
    static final int DATABASE_VERSION = 850;
    /** @} */
...
//        ");");
        ...
        DialerSearchSupport.createDialerSearchView(db);
        /*
         * @}
         */
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
         ...
         *     new cluster following current one, such as: if (oldVersion == 850) {upgradeFrom850To851()})@{
         */
        if (oldVersion == 803) {
	...
	// modify by puyong@2014.09.10 for 			
				appendPhoneLookupTables(sb, minMatch, true);
				...
				appendPhoneLookupSelection(sbb, null, null);
				qb.appendWhere(sbb.toString());
...
*/        
    ...
    public void updateRawContactDisplayName(SQLiteDatabase db, long rawContactId) {
        ...
        /// M: dialer search @{
        if (FeatureOption.MTK_SEARCH_DB_SUPPORT) {
            DialerSearchSupport.setNameForDialerSearch(mDialerSearchNameUpdate, db, rawContactId,
                    displayNamePrimary, displayNameAlternative);
        }
        /// @}
    }
