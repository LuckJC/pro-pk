...
import com.android.providers.contacts.DialerSearchSupport.DialerSearchLookupType;
...
//        sCallsProjectionMap.put(Calls._ID, Calls._ID);
    ...
    public boolean onCreate() {
        ...
        // M: MoMS for controling database access ability
        setQueryPermission(SubPermissions.QUERY_CALL_LOG);
        ...
        LogUtils.i(TAG, "onCreate(), notifyNewCallsCount");
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        try {
            ...
            err.printStackTrace();
            LogUtils.d(TAG, "insert()- 1 =========== Time:" + (System.currentTimeMillis() - lStart));
            return null;
        }
        ...
        LogUtils.i(TAG, "insert()- =========== Time:" + (System.currentTimeMillis() - lStart));
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        /**
         * M: Original Android code final SQLiteDatabase db =
        ...
        case CALLS: {
            ...
            if (count > 0) {
                notifyDialerSearchChange();
                LogUtils.d("zhpzdhan", "CallLogProvider---notify---");
                notifyNewCallsCount(db, getContext());
            }
            return count;
        }
    ...
    */
    ...
    /**M insert dialerSearch with number not stored in contacts.@{ */
