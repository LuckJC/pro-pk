...
public class StubTest extends
    ...
    public void testCase06tableBad() {
        ...
        select.getLocationOnScreen(loc);
        mSolo.clickOnScreen(loc[0] + 20, loc[1] + 20);
        mSolo.sleep(1000);
        // assertNotNull(table.getSelection());
        ...
        table.getSelection().getLocationOnScreen(loc);
        int viewWidth = table.getSelection().getWidth();
        int viewHeight = table.getSelection().getHeight();
        float radio = Math.min(width * 1.0f / viewWidth, 1.0f * height
                / viewHeight);
        int x = loc[0] + (int) (viewWidth * radio / 2);
        int y = loc[1] + (int) (viewHeight * radio / 2);
        mSolo.drag(x, x - 100, y, y, 3);
        mSolo.sleep(1000);
        mSolo.drag(x, x + 100, y, y, 3);
        mSolo.sleep(1000);
        mSolo.clickOnScreen(x, y);
        mSolo.sleep(2000);
        // assertNull(table.getSelection());
    }
    ...
    public void testCase07tableSelect() {
        ...
        ReflectionHelper.setFieldValue(table, "mMaxSelectionTime", 10000);
        LinkedList<View> viewList = (LinkedList<View>) ReflectionHelper
                .getObjectValue(table.getClass(), "mOnTable", table);
        View select = null;
        boolean cont = true;
        ...
        mSolo.sleep(12000);
        // assertNull(table.getSelection());
        ReflectionHelper.setFieldValue(table, "mStoryModeEnabled", false);
        i = 0;
        cont = true;
        while (cont) {
            try {
        ...
        // assertNotNull(table.getSelection());
        table.getSelection().getLocationOnScreen(loc);
        viewWidth = table.getSelection().getWidth();
        viewHeight = table.getSelection().getHeight();
        radio = Math.min(width * 1.0f / viewWidth, 1.0f * height
                / viewHeight);
        x = loc[0] + (int) (viewWidth * radio / 2);
        y = loc[1] + (int) (viewHeight * radio / 2);
        mSolo.drag(x, x + 100, y, y, 3);
        mSolo.sleep(1000);
        // assertNull(table.getSelection());
        i = 0;
    ...
    public void testCase10photoRotate() {
        ...
        mSolo.sleep(500);
        // assertTrue(Math.abs(backupRotation - select.getRotation()) < 1);
