...
public final class EmojiPalettesView extends LinearLayout implements OnTabChangeListener,
    ...
    /// M: There used for abort the repeat timer when the palette
    ///    would be destroyed. @{
    public void abortDeleteKeyRepeat() {
        mDeleteKeyOnTouchListener.abortRepeat();
    }
    /// @}
    ...
    private static class DeleteKeyOnTouchListener implements OnTouchListener {
        ...
        /// M: Stop the repeat timer when the palette is finished. @{
        ...
        /// M: Delete operation should post to the main thread handle. @{ 
        public void pressDelete(final int repeatCount) {
            if (mKeyboardActionListener instanceof LatinIME) {
                LatinIME latinIME = (LatinIME)mKeyboardActionListener;
