...
public final class SubtypeSwitcher {
    ...
    public void updateParametersOnStartInputView() {
        ...
        /// M: This time we should update whether the input language same as the system language. @{
        final Locale newLocale = getCurrentSubtypeLocale();
        final Locale systemLocale = mResources.getConfiguration().locale;
        final boolean sameLocale = systemLocale.equals(newLocale);
        final boolean sameLanguage = systemLocale.getLanguage().equals(newLocale.getLanguage());
        final boolean implicitlyEnabled =
                mRichImm.checkIfSubtypeBelongsToThisImeAndImplicitlyEnabled(getCurrentSubtype());
