...
public final class SuggestionStripView extends RelativeLayout implements OnClickListener,
    ...
    boolean showMoreSuggestions() {
        ...
        /// M: We should use the real suggestions count in the strip rather than the max count; @{
        builder.layout(mSuggestedWords, layoutHelper.mRealSuggestionsCountInStrip, maxWidth,
