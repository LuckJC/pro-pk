...
public final class RichInputConnection {
    ...
    public int getCodePointBeforeCursor() {
        /// M: Sometimes the mCommittedTextBeforeComposingText may be out-of-date, we should
        ///    update it. @{
        if (mCommittedTextBeforeComposingText.length() < 1){
            resetCachesUponCursorMoveAndReturnSuccess(-1, false);
        }
        /// @}
