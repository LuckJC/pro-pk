...
public final class RichInputMethodManager {
    ...
    private void initInternal(final Context context, final SharedPreferences prefs) {
        ...
        /// M: Refer to RichInputMethodManager.setAdditionalInputMethodSubtypes(), this method
        ///    is added by MTK to update the input method info in time. @{
        setAdditionalInputMethodSubtypes(context, additionalSubtypes);
        /// @}
    }
    ...
    /// M: 1. Input method info for this ime will change after this method, we should update it after the
    ///       input method info changed.
    ///    2. Since get the input method info, a Context is needed, so a parameter context is added. @{
    public void setAdditionalInputMethodSubtypes(final Context context, final InputMethodSubtype[] subtypes) {
