...
public class InCallActivity extends Activity {
    ...
    // use for four types: google default error dialog / SuppMessage dialog / VT drop back dialog / recording storage full dialog
    ...
    public void showStorageFullDialog(final int resid, final boolean isSDCardExist) {
        ...
        CharSequence cancelButtonText = isSDCardExist ? getResources().getText(
                R.string.alert_dialog_dismiss) : getResources().getText(R.string.ok);
        ...
        if (isSDCardExist) {
            dialogBuilder.setPositiveButton(
                    getResources().getText(R.string.vt_change_my_pic), oKClickListener);
        }
