        ...
        mOverlayGestureListener = new ItemMoveGestureListener() {
            ...
            public boolean onSingleTapConfirmed(View view, int area, MotionEvent e) {
                if (mPlaybackInProgress) {
                    MtkLog.d(TAG, "onSingleTapConfirmed: mPlaybackInProgress is true");
                    return false;
                }

                switch (((OverlayView)view).getState()) {
                    case OverlayView.STATE_STUB: {
                        MtkLog.d(TAG, "onSingleTapConfirmed: STATE_STUB");
                        /// M: @{
                        if (ApiService.isProjectBeingEdited(mProject.getPath())) {
                            MtkLog.d(TAG, "onSingleTapConfirmed: project is busy");
                            return false;
                        }
                        /// M: @}
                        unselectAllViews();
                    ...
                    case OverlayView.STATE_ADD_BUTTON: {
                        MtkLog.d(TAG, "onSingleTapConfirmed: STATE_ADD_BUTTON");
                        /// M: @{
                        if (ApiService.isProjectBeingEdited(mProject.getPath())) {
                            MtkLog.d(TAG, "onSingleTapConfirmed: project is busy");
                            return false;
                    ...
                    case OverlayView.STATE_OVERLAY: {
                        MtkLog.d(TAG, "onSingleTapConfirmed: STATE_OVERLAY");
                        if (!view.isSelected()) {
