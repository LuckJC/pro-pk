...
public class AudioTrackLinearLayout extends LinearLayout {
    ...
    /// M: ALPS00687819 for disable and enable add audio button
    ...
    public View addAudioTrack(MovieAudioTrack audioTrack) {
        ...
        if (audioTrack.getWaveformData() != null) {
            MtkLog.d(TAG, "addAudioTrack() setWaveformData:" + audioTrack.getWaveformData());
            audioTrackView.setWaveformData(audioTrack.getWaveformData());   
        } else {
            MtkLog.d(TAG, "addAudioTrack() call ApiService.extractAudioTrackAudioWaveform()");
    ...
    /// M: ALPS00687819 set add audio button disable or not when project is being edited.
    public void setAddAudioTrackEnbale(boolean enable) {
        MtkLog.d(TAG, "setAddAudioTrackEnbale() " + enable);
        mAddAudioTrackButtonView.setAlpha(enable ? ALPHA_ENABLE : ALPHA_DISABLE);
        mAddAudioTrackButtonView.setEnabled(enable);
    }
