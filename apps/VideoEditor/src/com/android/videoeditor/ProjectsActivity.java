...
public class ProjectsActivity extends NoSearchActivity {
    ...
    ///M: PopupMenu leak for not dismiss
    ...
    public void onResume() {
        ...
        MtkLog.d(TAG, "onResume() start load prject ");
    ...
    protected void onDestroy() {
        /// M: ALPS01236532 Avoid window leak
        if (mPopupMenu != null) {
            mPopupMenu.dismiss();
            mPopupMenu = null;
        }
    ...
    private class StorageListener extends StorageBroadcastReceiver {
        ...
        protected void onMounted(String storagePath) {
            ...
            MtkLog.d(TAG, "onMounted() load projects. storagePath:" + storagePath);
            ApiService.loadProjects(ProjectsActivity.this);
        }

        @Override
        protected void onUnMounted(String storagePath) {
            MtkLog.d(TAG, "onUnMounted() load projects. storagePath:" + storagePath);
            super.onUnMounted(storagePath);
            mUiHandler.removeCallbacks(mLoadRunnable);
            mUiHandler.postDelayed(mLoadRunnable, 200);
        }
    };
    /// @}
}
