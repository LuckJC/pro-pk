...
public class AlarmClockFragment extends DeskClockFragment implements
	...
	if(isSmallLCM){
	       FrameLayout footer_view = (FrameLayout) v.findViewById(R.id.alarms_footer_view);
    ...
    private void launchRingTonePicker(Alarm alarm) {
        ...
        //add-s by minesea 2014/8/1 11:47:14 for add more sound
        intent.putExtra(RingtoneManager.EXTRA_RINGTONE_SHOW_MORE_RINGTONES, true);
        //add-e by minesea 2014/8/1 11:47:14 for add more sound
    ...
    public class AlarmItemAdapter extends CursorAdapter {
		...
		if(isSmallLCM) //addb mokj
			AlarmUtils.showTimeEditDialogEx(getChildFragmentManager(),
