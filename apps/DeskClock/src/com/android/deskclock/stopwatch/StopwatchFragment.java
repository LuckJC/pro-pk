...
public class StopwatchFragment extends DeskClockFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLayoutTransition.addTransitionListener(new LayoutTransition.TransitionListener() {
            ...
            public void startTransition(LayoutTransition transition, ViewGroup container,
                ...
                if (view.equals(mLapsList)) {
                    if (transitionType == LayoutTransition.DISAPPEARING) {
                        if (DEBUG) {
                            Log.v("StopwatchFragment.start laps-list disappearing");
                        }
            ...
            public void endTransition(LayoutTransition transition, ViewGroup container,
                ...
                if (transitionType == LayoutTransition.DISAPPEARING) {
                    if (DEBUG) {
                        Log.v("StopwatchFragment.end laps-list disappearing");
                    }
                    int last = mLapsList.getLastVisiblePosition();
    ...
    private void doStop() {
        if (DEBUG) {
            Log.v("StopwatchFragment.doStop");
        }
        stopUpdateThread();
    ...
    private void doStart(long time) {
        if (DEBUG) {
            Log.v("StopwatchFragment.doStart");
        }
        mStartTime = time;
        startUpdateThread();
        mTimeText.blinkTimeStr(false);
    ...
    private void doReset() {
        if (DEBUG) {
            Log.v("StopwatchFragment.doReset");
        }
        /**
    ...
    private void showLaps() {
        if (DEBUG) {
            Log.v(String.format("StopwatchFragment.showLaps: count=%d",
