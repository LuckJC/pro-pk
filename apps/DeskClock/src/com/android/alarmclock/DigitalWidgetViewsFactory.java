...
public class DigitalWidgetViewsFactory implements RemoteViewsFactory {
    ...
    private class RemoteWorldClockAdapter extends WorldClockAdapter {
        ...
        public RemoteViews getViewAt(int position) {
            ...
            Log.v(TAG, "DigitalWidgetViewsFactory getViewAt = " + position);
    ...
    @Override
    public int getCount() {
        Log.v(TAG, "DigitalWidgetViewsFactory getCount");
        if (WidgetUtils.showList(mContext, mId, mFontScale)) {
            Log.v(TAG, "DigitalWidgetViewsFactory getCount = " + mAdapter.getCount());
    ...
    public RemoteViews getViewAt(int position) {
        ...
        Log.v(TAG, "RemoteViews getViewAt: " + position + " RemoteViews = " + v);
        if (v != null) {
