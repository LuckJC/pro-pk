...
public abstract class AccountType {
    ...
    public Drawable getDisplayIconBySlotId(Context context, int slotid) {
        ...
        if (this.titleRes != -1 && this.syncAdapterPackageName != null) {
            ...
            // FOR CT NEW FEATURE
            Drawable ctSimIndicator = ExtensionManager.getInstance()
                    .getContactDetailEnhancementExtension()
                    .getEnhancementAccountSimIndicator(i, slotid,
                            ContactPluginDefault.COMMD_FOR_OP09);
            if (ctSimIndicator != null) {
                return ctSimIndicator;
            } else {
                if (i == 0) {
                    photo = R.drawable.mtk_ic_contact_account_sim_blue;
                } else if (i == 1) {
                    photo = R.drawable.mtk_ic_contact_account_sim_orange;
                } else if (i == 2) {
                    photo = R.drawable.mtk_ic_contact_account_sim_green;
                } else if (i == 3) {
                    photo = R.drawable.mtk_ic_contact_account_sim_purple;
                } else {
