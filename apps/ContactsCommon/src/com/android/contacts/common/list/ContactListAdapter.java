...
public abstract class ContactListAdapter extends ContactEntryListAdapter {
    ...
    /**
     * M:fix ALPS00881472:Two name in my local profile.
     * Don't showEmptyUserProfile if the Data hasn't been loaded from DB.
     * If not:User can input profile by click the empty user profile again.
     */
    ...
    /**
     * Indicate whether the DB query has complete
     */
