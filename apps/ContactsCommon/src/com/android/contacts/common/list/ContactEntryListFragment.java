...
public abstract class ContactEntryListFragment<T extends ContactEntryListAdapter>
    ...
    public void onCreate(Bundle savedState) {
        ...
        ///M:don't creawte adapter here,some child can't init the right status@{
        ...
        intentFilter.addAction(ExtensionManager.RCS_CONTACT_UNREAD_NUMBER_CHANGED);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == DIRECTORY_LOADER_ID) {
            ...
            mAdapter.setShowCTInternationNumber(isShowCTInternationNumber());
            // @}
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
      ///M:check whether the fragment still in Activity@{
        ...
        if (!mEnabled) {
            Log.i(TAG, "return in onLoad finish,mEnabled:" + mEnabled);
            return;
        }
        ...
        if (loaderId == DIRECTORY_LOADER_ID) {
            ...
            Log.i(TAG, "onLoadFinished startloading,loaderId:" + loaderId);
            startLoading();
        } else {
    ...
    private BroadcastReceiver mRCSPresenceChangedListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if(ExtensionManager.RCS_CONTACT_UNREAD_NUMBER_CHANGED.equals(intent.getAction()))
            {
            	mAdapter.notifyDataSetChanged();
    ...
    ///M: For CT New Feature @{
    //By default we show SDN Number in screen
