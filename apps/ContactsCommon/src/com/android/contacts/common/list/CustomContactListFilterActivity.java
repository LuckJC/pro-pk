        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                ...
                if (FeatureOption.MTK_ONLY_OWNER_SIM_SUPPORT) {
                    if (userId != UserHandle.USER_OWNER) {
                        if (accountType != null && isAccountTypeSimUsim(accountType.accountType)) {
                            continue;
                        }
                    }
                }
    ...
    /**
     * For MTK new feature: multiuser in 3gdatasms
     * Is Account type sim or usim? 
     */
    private static boolean isAccountTypeSimUsim(String accountType) {
        boolean ret = false;
