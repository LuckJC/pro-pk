...
//        }
    ...
    public long getSimType(int indicate, int isSdnContact) {
        ...
        // for CT NEW FEATURE
        photoId = ExtensionManager.getInstance().getContactDetailEnhancementExtension()
                .getEnhancementPhotoId(isSdnContact, i, mSlot, ContactPluginDefault.COMMD_FOR_OP09);
        if (photoId == -1) {
    ...
    /**
     * ct new feature don't show 18900189000 number when multiple delete
     */
    public boolean mShowCTInternationNumber = true;

    public void setShowCTInternationNumber(boolean canDelete) {
        mShowCTInternationNumber = canDelete;
    }
}
