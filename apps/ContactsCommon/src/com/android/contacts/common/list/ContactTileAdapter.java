...
public class ContactTileAdapter extends BaseAdapter {
    ...
    protected ContactEntry createContactEntryFromCursor(Cursor cursor, int position) {
         ...
         */
        contact.indexSimOrPhone = cursor.getInt(cursor.getColumnIndex(Contacts.INDICATE_PHONE_SIM));
        ...
        if (slotId < 0) {
            ...
            int isSdnContact = cursor.getInt(cursor.getColumnIndex(Contacts.IS_SDN_CONTACT));
