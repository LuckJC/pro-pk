...
public class IccCardExtension {
    ...
    /**
     * M: get the COMMD_FOR_OPxx
     * 
     * @return the text of command
     */
    ...
    /**
     * M: provide the SimInfoRecord, to let the plug-in decide which default photo should be
     * provided to host to show on Edit view
     * 
     * @param simInfo
     * @param commd
     ...
     * 
     * @param args
     *            KEY_IS_ICC_CONTACT_SDN => Boolean: is the contact an SDN contact 
     *            KEY_ICC_COLOR_ID => Integer: the color id, 0 -> blue; 1 -> orange; etc
     * @param commd
     ...
     * @param args
     *      KEY_IS_DARK_THEME => Boolean
     *          whether the Host need a dark theme photo
     *      KEY_PHOTO_ID => Long
     *          specify the id of the photo host needed, can't exist along with KEY_PHOTO_URI
     *      {@link #KEY_PHOTO_URI} => Parcelable(Uri)
     *          specify the uri of the photo host needed, can't exist along with {@link #KEY_PHOTO_ID}
     * @param commd
     * @return
     *      the Drawable for the Icc Card photo, which host needs
     */
