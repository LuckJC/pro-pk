...
public class ContactAccountExtension {
     ...
     * @return true to show App Guide,false else.
     */
    public boolean setVcsAppGuideVisibility(Activity activity, boolean visible, OnGuideFinishListener listener, String commd) {
        return false;
    }
