...
public final class MailPrefs extends VersionedPrefs {
    ...
    public boolean getIsAutoBccMyselfEnabled() {
        return getSharedPreferences().getBoolean(PreferenceKeys.BCC_MYSELF_KEY, PreferenceKeys.BCC_MYSELF_DEFAULT);
    }

    public void setAutoBccMyself(boolean enabled) {
        getEditor().putBoolean(PreferenceKeys.BCC_MYSELF_KEY, enabled).apply();
        notifyBackupPreferenceChanged();
    }
    /**@}*/
