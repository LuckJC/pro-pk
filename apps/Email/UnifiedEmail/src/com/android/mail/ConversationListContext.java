...
public class ConversationListContext {
    ...
    /**
     * M: Indicate local searching, if any.@{
     */
    ...
    /// M: add for mediatek local search @ {
    ...
    public static final boolean isSearchResult(ConversationListContext in) {
        return in != null && !TextUtils.isEmpty(in.searchQuery) &&/**M:*/ !in.localSearch;
    }

    /**
     * M: Return whether this is a remote search context or not.
     * @return
     */
    ...
    /**
     * M: Returns true if the query isn't empty under local search.
