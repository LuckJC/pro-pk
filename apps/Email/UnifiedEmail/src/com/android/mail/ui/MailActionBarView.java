...
public class MailActionBarView extends LinearLayout implements ViewMode.ModeChangeListener,
     ...
     */
    protected int mMode = ViewMode.UNKNOWN;
    ...
    /**
     * M: Set protected to be used by extend
    ...
    protected MenuItem mSendFeedbackItem;
    protected MenuItem mRefreshItem;
    protected MenuItem mFolderSettingsItem;
    ...
    /**
     * M: EmailActionBarView will implement it
     */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (mSearch != null) {
            ...
            if (searchManager != null && mSearchWidget != null) {
                ...
                /// M: The SearchableInfo may be customized by Email, and we need checking its validation.
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (mFolderSettingsItem != null) {
            /*
             * M: Disable the sync option if the folder is draft or out-box.
             */
            mFolderSettingsItem.setVisible(mFolder != null
                    && mFolder.supportsCapability(FolderCapabilities.SUPPORTS_SETTINGS)
                    && !(mFolder.isDraft() || mFolder.isType(UIProvider.FolderType.OUTBOX)));
        }
    ...
    /// M: show local/remote search result, EmailActionBarView will override this method.
