...
public class OnePaneController extends AbstractActivityController {
    ...
    public boolean onCreate(Bundle savedInstanceState) {
        PDebug.Start("OnePaneController.onCreate");
        ...
        PDebug.End("OnePaneController.onCreate");
    ...
    /**
     * M: Conversation list fragment is always collapsable.
     */
    @Override
    protected boolean isConversationListCollapsable() {
        return true;
    }
    ...
    private int replaceFragment(Fragment fragment, int transition, String tag, int anchor) {
        final FragmentManager fm = mActivity.getFragmentManager();
        /**
         * M: if the activity is nonexistent or destroyed, just only return and
         * do nothing. @{
         */
        if (fm == null || fm.isDestroyed()) {
            LogUtils.d(LOG_TAG, "warning, activiy is destroyed, mActivity=%s", mActivity);
            return -1;
        }
        /** @} */
    ...
    /**
     * M: Is it expansive layout. False for one panel
     */
    @Override
