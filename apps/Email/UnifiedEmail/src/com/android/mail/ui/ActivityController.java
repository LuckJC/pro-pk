...
public interface ActivityController extends LayoutListener,
        ...
        /// M: Add EmailConntectvityStateChangeListener to notify connectivity state change to Activity
    ...
    /**
     * M: Returns the current connectivity manager.
     */
    EmailConnectivityManager getConnMgr();
    ...
    /**
     *  M: Called when user press search menu or switch search field tab.
     */
    void enterLocalSearch(String field);

    /**
     *  M: Called when user press back key to exit local search mode.
     */
    void exitLocalSearch();

    /**
     *  M: Called to execute keywords local search.
     */
    void executeLocalSearch(String query);

    /**
     * M: Is it expansive layout
     */
