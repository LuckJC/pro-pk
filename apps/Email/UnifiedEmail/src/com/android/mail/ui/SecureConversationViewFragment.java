...
public class SecureConversationViewFragment extends AbstractConversationViewFragment
    ...
    private class SecureConversationWebViewClient extends AbstractConversationWebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (isUserVisible()) {
                ...
                LogUtils.d(LOG_TAG, "[Performance test][Email][Email_008][%d] Content show time end [%s]",
                        mConversation.id, System.currentTimeMillis());
            }
    ...
    @Override
    ///M: destory view and release some resource, e.g. AysncTask.
    ...
    private void renderMessage(MessageCursor newCursor) {
        ...
        /// M: add for highlight search key words.
    ...
    public void onConversationUpdated(Conversation conv) {
        LogUtils.d(LOG_TAG, "____________________________onConversationUpdated");
