...
public class WaitFragment extends Fragment implements View.OnClickListener,
    ...
    private View getContent(ViewGroup root) {
        ...
        if (mAccount != null
            ...
            ///M: check the connectivity when launch this fragment. @{
            if (!Utility.hasConnectivity(getActivity())) {
                TextView title = (TextView) view.findViewById(R.id.wait_for_sync_title);
                TextView body = (TextView) view.findViewById(R.id.wait_for_sync_body);
                title.setText(R.string.unable_to_connect);
                body.setText(R.string.need_connection_prompt);
            }
            /// @}
        }
