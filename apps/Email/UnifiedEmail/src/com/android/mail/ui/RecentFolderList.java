...
public final class RecentFolderList {
    ...
    /**
     *  M: We want to show at most three recent folders
     */
    private final static int MAX_RECENT_FOLDERS = 3;
    /**
    ...
    public ArrayList<Folder> getRecentFolderList(final FolderUri excludedFolderUri) {
        ...
        /// M: Remove below method to make it sorted by the last seen time of folder
