...
final class TwoPaneLayout extends FrameLayout implements ModeChangeListener {
    ...
    /**
     * M: Whether or not the conversation list is collapsable.
     * @return Whether or not the conversation list is collapsable.
     */
    public boolean isConversationListCollapsable() {
