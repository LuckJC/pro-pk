...
public class ConversationPagerController {
     ...
     * M: Enable singleton mode to improve page loading in ViewPager and avoid paging at wrong time
     */
    ...
    /**
     * M: Create pager adatper, we could inherit from it to do different things
     */
    protected ConversationPagerAdapter createPagerAdapter(Account account, Folder folder,
            Conversation initialConversation) {
        return new ConversationPagerAdapter(mPager.getResources(), mFragmentManager,
    ...
    public void show(Account account, Folder folder, Conversation initialConversation,
        ...
        /// M: Create pager adapter @{
        mPagerAdapter = createPagerAdapter(account, folder, initialConversation);
        /// @}
    ...
    public void onConversationSeen() {
        ...
        if (mPagerAdapter.isSingletonMode()
                /** M: Keep in singleton mode when necessary */
                && !mPagerAdapter.isNeedSingletonMode()) {
