...
public class Attachment implements Parcelable {
    ...
    ///M: Add for Eml file's attachment's name is null
    ...
    /**
     * M: add for changing inferredContentType in some case, such as check viewable failed
     * and found another correct mimetype to use.
     * @param inferredContentType
     */
    public void setInferredContentType(String inferredContentType) {
        if (!TextUtils.equals(this.inferredContentType, inferredContentType)) {
