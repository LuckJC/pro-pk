...
public class UIProvider {
    /// M: Email provider authority @{
    public static final String EMAIL_PROVIDER_AUTHORITY = "com.android.email.provider";
    /// @}
    ...
    public static final String[] FOLDERS_PROJECTION = {
        ...
        FolderColumns.LAST_NOTIFIED_MESSAGE_KEY,
        ///M: support local search.
        FolderColumns.LOCAL_SEARCH_LIST_URI
    };
    ...
    ///M:repeat alert when mark unread flag on another device
    public static final int FOLDER_LAST_NOTIFIED_MESSAGE_KEY_COLUMN = 24;
    ///M: support local search.
    public static final int FOLDER_LOCALSEARCH_LIST_URI_COLUMN = 25;
    ...
    public static final class FolderColumns {
        ...
        ///M: add for local search, new Uri reference to 'conversationListUri'
        public static final String  LOCAL_SEARCH_LIST_URI = "localsearchListUri";
        /**
         * This string column contains the content provider uri to return the
    ...
    public static final class ConversationCursorCommand {
        ...
        /**
         * M: This bundle key return the type of mailbox the current cursor belonged to
         * <p>
         * A provider that implements this command should include this key in its response with a
         * value of {@link #COMMAND_RESPONSE_OK} or {@link #COMMAND_RESPONSE_FAILED}.
         * @{ **/
        ...
        /**
         * M: This bundle key indicate to move position of curosr for purpose of filtering Vip msgs
         * <p>
         * A provider that implements this command should include this key in its response with a
         * value of {@link #COMMAND_RESPONSE_OK} or {@link #COMMAND_RESPONSE_FAILED}.
         * @{ **/
    ...
    public static final String[] MESSAGE_PROJECTION = {
        ...
        MessageColumns.STATE,
        /// M: Extend flags of Message
        MessageColumns.FLAG_EXTEND
    };
    ...
    public static final int MESSAGE_STATE_COLUMN = 36;
    /// M: End
    /// M: Extend flags of Message.
    public static final int MESSAGE_FLAG_EXTEND_COLUMN = 37;
    ...
    public static final class CursorExtraKeys {
        ...
        /**
         * M: This boolean column contains the messages have load finished or not
         */
        public static final String EXTRA_MESSAGES_LOAD_FINISH = "messages_load_finish";
    }
    ...
    /** M: Extend flags of Message. @{ */
    public static final class MessageExtendFlags {
        public static final int BODY_TOO_LARGE =   1 << 0;
        public static final int BODY_COMPRESSED =  1 << 1;
    }
    /** @} */

    /**
     * M :Valid states for the {@link MessageColumns#UI_STATE} column.
     * For UI update of partial download
     */
    public static final class MessageState {
        /**
         * Valid next states: {@link #LOADING}
         */
        public static final int NONE = 0;
        /**
         * Valid next states: {@link #FAILED}, {@link #SUCCESS}
         */
        public static final int LOADING = 1;
        /**
         * Valid next states: {@link #NONE}
         */
    ...
    /**
     * M: Valid states for the {@link MessageColumns#IS_SENDING} column.
     */
    public static final class MessageSendingState {
        /**
         * Valid next states: {@link #SENDING}
         */
        public static final int NOT_SENDING = 0;
        /**
         * Valid next states: {@link #NOT_SENDING}
         */
    ...
    public static final class MessageColumns {
        ...
        /**
         * M: This interger column indicates the status of the message been loaded
         * See {@link EmailContent.Message.FLAG_LOADED_PARTIAL}, etc
         */
        public static final String FLAG_LOADED = "flagLoaded";
        /**
         * M: This integer column is the current loading state of the
         * message as defined in {@link MessageState}.
         * <p>
         * Providers must accept updates to {@link #URI} with new values of
         * this column to initiate fetching the partial downloaded messages
         */
        public static final String STATE = "state";

        /**
         * M: This interger column indicates the extend flags of the message
         * See {@link MessageExtendFlags}, etc
         */
        public static final String FLAG_EXTEND = "flagExtend";
