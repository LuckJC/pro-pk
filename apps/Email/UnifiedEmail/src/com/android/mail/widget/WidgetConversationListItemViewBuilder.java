...
public class WidgetConversationListItemViewBuilder {
    ...
    public RemoteViews getStyledView(final CharSequence date, final Conversation conversation,
        ...
        if (isUnread) {
            ...
            ///M: let unread image visible
            remoteViews.setViewVisibility(R.id.widget_unread_state, View.VISIBLE);
        } else {
            ...
            ///M: let unread image invisible
            remoteViews.setViewVisibility(R.id.widget_unread_state, View.INVISIBLE);
        }
