...
public class NotificationActionUtils {
    ...
    ///M: Add Vip support
    public static final int CHECK_VIP_MASK = 1 << 31;
    ...
    private static PendingIntent getNotificationActionPendingIntent(final Context context,
        ...
        /// M: Add a parameter notificationId to save the id of this notification.
        final NotificationAction notificationAction = new NotificationAction(action, account,
                conversation, message, folder, conversation.id, message.serverId, message.id, when, notificationId);
    ...
    public static class NotificationAction implements Parcelable {
        ...
        /// M: Add this field to save the id of this notification.
        private final int mNotificationId;

        /// M: Add a parameter { final int notificationId } to save the id of notification.
        public NotificationAction(final NotificationActionType notificationActionType,
                ...
                final long localMessageId, final long when, final int notificationId) {
            ...
            mWhen = when;
            /// M: Set the id of this notification.
        ...
        public void writeToParcel(final Parcel out, final int flags) {
            ...
            out.writeLong(mWhen);
            /// M: Write the notification id to parcel.
        ...
        private NotificationAction(final Parcel in, final ClassLoader loader) {
            ...
            mWhen = in.readLong();
            /// M: Get the notification id from the parcel.
    ...
    public static void createUndoNotification(final Context context,
        ...
        /// M: Get the notificationId from the passed notificationAction.
    ...
    public static void cancelUndoNotification(final Context context,
        ...
        /// M: Get the notificationId from the passed notificationAction.
        removeUndoNotification(context, notificationAction.getNotificationId(), false);
