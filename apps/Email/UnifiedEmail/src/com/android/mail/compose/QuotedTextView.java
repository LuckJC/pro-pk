        ...
        if (action == ComposeActivity.REPLY || action == ComposeActivity.REPLY_ALL) {
            ...
            quotedText
                    .append(String.format(
                            ...
                            Utils.cleanUpString(
                                    /** M: Unpack packed Address Strings for better human readable */
                                    Address.unpackToString(refMessage.getFrom()), true)));
            ...
            quotedText
                    .append(String.format(resources.getString(R.string.forward_attribution), Utils
                            .cleanUpString(Address.unpackToString(refMessage.getFrom()),
                            ...
                            .cleanUpString(refMessage.subject,
                                    false /* don't remove empty quotes */), Utils.cleanUpString(
                                            Address.unpackToString(refMessage.getTo()), true)));
            /** M: Unpack packed Address Strings for better human readable */
            String ccAddresses = Address.unpackToString(refMessage.getCc());
