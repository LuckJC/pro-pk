...
/// M: Add for messy code, need move to protected later
...
public class MimeUtility {
    ...
    /**
     * M: This value indicate that we will compress the message body if its size(string's length)
        ...
        try {
            if (part != null && part.getBody() != null) {
                ...
                if (mimeType != null && MimeUtility.mimeTypeMatches(mimeType, "text/*")) {
                     ...
                     */
                    if (charset == null) {
                        charset = CharsetUtilities.emailCharsetDetect(new ByteArrayInputStream(out.toByteArray()));
                        Log.d(LOG_TAG, "Body Stream charset is: " + charset);
                        if (charset == null) {
                            charset = "ASCII";
                        }
                    }
    ...
    public static Body decodeBody(InputStream in, String contentTransferEncoding)
        ...
        try {
            ...
            Log.e(LOG_TAG, "decodeBody Base64DataException Exception: " + bde);
        } catch (IOException ioe) {
            Log.e(LOG_TAG, "decodeBody Exception: " + ioe);
            ((BinaryTempFileBody) tempBody).deleteFile();
            throw ioe;
        } finally {
            out.close();
        }
    ...
    public static void collectParts(Part part, ArrayList<Part> viewables,
        ...
        /// M: Change to older version of collectParts(add RFC822 processing etc.) @{
