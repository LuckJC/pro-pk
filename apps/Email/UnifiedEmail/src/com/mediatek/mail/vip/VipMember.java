...
public class VipMember extends EmailContent implements Parcelable{
    ...
    /**
     * Add VIPs with addresses. But the duplicates and invalid addresses will not be added.
    ...
    public static void addVIPs(Context context, long accountId, ArrayList<Address> addresses,
        ...
        boolean hasDuplicateAddress = removeDuplicateAddress(addressesList);
        ...
        collectEmailAddresses(vipList, addressesList, vipAddresses, nonVipAddresses, updatedVips);
