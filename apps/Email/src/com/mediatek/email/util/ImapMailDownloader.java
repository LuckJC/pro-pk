...
public class ImapMailDownloader {
    ...
    public static void loadUnsyncedMessages(final Context context, final Account account,
        ...
        for (Message message : unsyncedMessages) {
            ...
            if (message.getSize() > (MAX_SMALL_MESSAGE_SIZE) || message.getSize() == 0) {
                ...
                boolean isPartialDownload = imapPartialFetchMessage(message,
                        remoteFolder);
     ...
     */
    public static boolean imapPartialFetchMessage(Message message, Folder remoteFolder) throws MessagingException{
