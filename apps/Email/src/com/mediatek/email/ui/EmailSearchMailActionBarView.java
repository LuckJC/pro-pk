 ...
 */
public class EmailSearchMailActionBarView extends MailActionBarView {

    private TextView mSearchResultCountView;
    private TextView mSearchTextView;
    private int mRemoteSearchResult = 0;

    public EmailSearchMailActionBarView(Context context) {
        this(context, null);
    }

    public EmailSearchMailActionBarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EmailSearchMailActionBarView(Context context, AttributeSet attrs, int defStyle) {
