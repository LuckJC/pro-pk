...
public class EmailPreferenceMigrator extends BasePreferenceMigrator {
    ...
    protected static void migrate(final Context context, final int oldVersion, final int newVersion,
        ...
        if (oldVersion < 1) {
            ...
            upgradeSettingsFromJB2ToKK(context);
    ...
    private static void upgradeSettingsFromJB2ToKK(Context context) {
        ...
        if (hasConformDelete) {
            ...
            Preferences.getPreferences(context).setConfirmDelete(conformDelete);
