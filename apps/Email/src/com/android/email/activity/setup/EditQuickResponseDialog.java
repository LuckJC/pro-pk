...
public class EditQuickResponseDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ///M: In case of ANR, add limitation to the input text length
        UiUtilities.setupLengthFilter(mQuickResponseEditText, getActivity(),
                Configuration.COMMON_EDITVIEW_MAX_LENGTH, true);
    ...
    public void onResume() {
        super.onResume();
        //M: keep the soft input when this window receives input focus
        mDialog.getWindow()
