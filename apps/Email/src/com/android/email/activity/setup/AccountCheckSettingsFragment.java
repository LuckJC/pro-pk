...
public class AccountCheckSettingsFragment extends Fragment {
    ...
    @Override
    public void onStop() {
        /// M: We need make sure that the checking dialog has dismissed, otherwise
        /// the checking dialog would become orphan and lost its target fragment.
        /// This would cause some framework JE happen.
        recoverAndDismissCheckingDialog();
        super.onStop();
    }
    ...
    public static class CheckingDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            ///M: make sure not dismiss the dialog,when user click the outside of screen.@{
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        /**
         * M: Listen for cancellation, and also call target's callback and finish AccountCheckSettingFragment.
         */
        @Override
        public void onCancel(DialogInterface dialog) {
            final AccountCheckSettingsFragment target =
