...
public class AccountSetupIncoming extends AccountSetupActivity
    ...
    public static void actionIncomingSettings(Activity fromActivity, SetupData setupData) {
        ...
        final Intent intent = new ForwardingIntent(fromActivity, AccountSetupIncoming.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /// M: data from manual_setup_helper may has prefix, so don't add it
        // again(in case of pop3.sina.com, pop as the prefix)
