...
public class AccountSettings extends PreferenceActivity implements FeedbackEnabledActivity,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LogUtils.d(Logging.LOG_TAG, "AccountSettings::onCreate");
    ...
    public void onResume() {
        super.onResume();
        LogUtils.d(Logging.LOG_TAG, "AccountSettings::onResume");
    ...
    @Override
    public void onPause() {
        LogUtils.d(Logging.LOG_TAG, "AccountSettings::onPause");
    ...
    protected void onDestroy() {
        LogUtils.d(Logging.LOG_TAG, "AccountSettings::onDestroy");
    ...
    public void onBackPressed() {
        ...
        if (mCurrentFragment instanceof AccountSettingsFragment) {
            final EmailServiceProxy proxy = EmailServiceUtils
                    .getServiceForAccount(this, mRequestedAccountId);
            try {
                proxy.stopOof(mRequestedAccountId);
            } catch (RemoteException e) {
                LogUtils.d(TAG, "stopOof is Error.");
            }
        }
        /** @} */
        super.onBackPressed();
    ...
    private class LoadAccountListTask extends AsyncTask<Long, Void, Object[]> {
        ...
        protected void onPostExecute(Object[] result) {
            ...
            ///M: Check the account change if all account delete we should go to AccountSetupBasic
                ...
                Utility.getMainThreadHandler().post(new Runnable() {
                    public void run() {
                        if (isResumed()) {
                            ...
                            Intent i = AccountSetupBasics.createIntent(AccountSettings.this);
    ...
    private class AccountServerSettingsFragmentCallback
        ...
        public void onProceedNext(int checkMode, AccountServerBaseFragment target) {
            /// M: Create a checking fragment and start to check account information.
            startCheckingFragment(checkMode, target);
        }

        /**
         * M: Create a retained, invisible fragment to check account information.
         */
