...
public class AccountSecurity extends Activity {
    ...
    public static class SecurityNeededDialog extends DialogFragment
        ...
        /**
         * M: Keep consistent with clicking cancel button which lie in account
         * need security update dialog when press back key. @{
         */
        @Override
        public void onCancel(DialogInterface dialog) {
            super.onCancel(dialog);
            AccountSecurity activity = (AccountSecurity) getActivity();
            activity.repostNotification(activity.mAccount, SecurityPolicy.getInstance(activity));
            activity.finish();
        }
        /** @} */
    }
