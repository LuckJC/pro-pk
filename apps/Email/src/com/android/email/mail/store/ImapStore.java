...
public class ImapStore extends Store {
    ...
    private ImapFolder addMailbox(Context context, long accountId, String mailboxPath,
        ...
        if (mailboxType == Mailbox.TYPE_NONE || mailboxType == Mailbox.TYPE_MAIL) {
            ...
            mailbox = Mailbox.restoreMailboxOfType(context, accountId, mailboxType);
            if (mailbox == null) {
                mailbox = new Mailbox();
            }
        }
    ...
    public Folder[] updateFolders() throws MessagingException {
        ...
        try {
            ...
            ImapFolder newFolder = addMailbox(mContext, mAccount.mId, ImapConstants.INBOX, '\0',
                    true /* selectable */, Mailbox.TYPE_INBOX);
