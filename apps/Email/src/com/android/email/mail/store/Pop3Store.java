...
/**
 * M: This class is google original Pop3Store, which we no longer use, instead we use
 * {@link com.mediatek.email.mail.store.Pop3Store}. We keep it here to track google's
 * update and for migration convenience.
 * @deprecated We use {@link com.mediatek.email.mail.store.Pop3Store}
 */
@Deprecated
public class Pop3Store extends Store {
    ...
    /**
     * M: M: Mark as deprecated to be not accessible.
     * @deprecated We use {@link com.mediatek.email.mail.store.Pop3Folder}
     */
    @Deprecated
    public class Pop3Folder extends Folder {
        ...
        public void fetchBody(Pop3Message message, int lines,
            ...
            String listResponse = executeSimpleCommand(String.format(Locale.US, "LIST %d", messageId));
            try {
    ...
    /**
     * M: Mark as deprecated to be not accessible.
     * @deprecated We use {@link com.mediatek.email.mail.store.Pop3Folder.Pop3Message}
     */
    @Deprecated
     ...
     * M: Mark as Deprecated to be not accessible.
     * @deprecated We use {@link com.mediatek.email.mail.store.Pop3Connection.Pop3Capabilities}
     */
    @Deprecated
    ...
    /**
     * M: Mark as Deprecated to be not accessible.
     * @deprecated We use {@link com.mediatek.email.mail.store.Pop3Folder.Pop3ResponseInputStream}
     */
    @Deprecated
