...
public class Preferences {
    ...
    private static final String AUTO_CLEAR_ATTACHMENTS = "auto_clear_attachments";
    private static final boolean AUTO_CLEAR_ATT_DEFAULT = true;
    /** @} */
    ...
    public boolean getEnableDebugLogging() {
        return mSharedPreferences.getBoolean(ENABLE_DEBUG_LOGGING, true);
    }
     ...
     * M: Support for auto-clear cache
     */
    public boolean getAutoClearAtt() {
        return mSharedPreferences.getBoolean(AUTO_CLEAR_ATTACHMENTS, AUTO_CLEAR_ATT_DEFAULT);
    }

    /**
     * M: Support for auto-clear cache @{
     */
    public void setAutoClearAtt(boolean auto) {
        mSharedPreferences.edit().putBoolean(AUTO_CLEAR_ATTACHMENTS, auto).apply();
    }
