...
interface IAccountService {
    ...
    /** M: For Exchange sending notification @{ */
    oneway void notifySendingStarted(long accountId, int messageCount);
    oneway void notifySendingFailed(long accountId, int messageCount);
    oneway void notifySendingSucceeded(long accountId, int messageCount);
    /** @} */
