...
public class Utility {
   ...
   public static String findExistingAccount(final Context context, final String syncAuthority,
    ...
    /**
     * M : add for checking file with this URI exists.
     * @param context
     * @param fileUri
     * @return
     */
    public static boolean fileExists(Context context, Uri fileUri) {
        if (fileUri == null) {
            ...
            try {
                final InputStream inStream = context.getContentResolver().openInputStream(fileUri);
                try {
                    inStream.close();
                } catch (IOException e) {
    ...
    /**
     * @TODO We should adjust the threshold and percent value here
     * <p>
