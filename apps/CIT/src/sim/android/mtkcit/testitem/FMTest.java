...
//			mCurrentStation = Integer.parseInt(frequency[0].trim());
		...
		mCurrentVolume = mAudioManager.getStreamVolume(AudioManager.STREAM_FM);
		mAudioManager.setStreamVolume(AudioManager.STREAM_FM, 10, 0);
	...
	public void releaseRec() {
		...
		mAudioManager
				.setStreamVolume(AudioManager.STREAM_FM, mCurrentVolume, 0);
