...
public class CellBroadcastSettings extends TimeConsumingPreferenceActivity
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (EncapsulatedTelephonyIntents.ACTION_SIM_INFO_UPDATE.equals(action)) {
                ///M: add for hot swap {
                handleSimHotSwap(CellBroadcastSettings.this, mSlotId);
                ///@}
            }
        }
    };
    ...
    private void setCellBroadcastConfig(SmsBroadcastConfigInfo[] objectList) {
        ...
        boolean isSetConfigSuccess = EncapsulatedSmsManager.setCellBroadcastSmsConfig(objectList, objectList, mSlotId);
    ...
    private static long getSiminfoIdBySimSlotId(int slotId, List<EncapsulatedSimInfoManager> simInfoList) {
