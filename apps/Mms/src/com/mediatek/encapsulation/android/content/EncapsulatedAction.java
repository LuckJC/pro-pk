...
public class EncapsulatedAction {
    ...
    public static final String EXTRA_DUAL_SIM_MODE;

    public static final String ACTION_DUAL_SIM_MODE_CHANGED;
    static {
        if (EncapsulationConstant.USE_MTK_PLATFORM) {
            ...
            EXTRA_DUAL_SIM_MODE = Intent.EXTRA_DUAL_SIM_MODE;
            ACTION_DUAL_SIM_MODE_CHANGED = Intent.ACTION_DUAL_SIM_MODE_CHANGED;
        } else {
            ...
            EXTRA_DUAL_SIM_MODE = "mode";
            ACTION_DUAL_SIM_MODE_CHANGED = "android.intent.action.DUAL_SIM_MODE";
        }
    }
