...
public class EncapsulatedPluginManager {
    ...
    public static Object createPluginObject(Context context, String pluginIntent,
            String version, String metaname, Signature... signatures) throws AndroidException {
        if (EncapsulationConstant.USE_MTK_PLATFORM) {
            return PluginManager.createPluginObject(context, pluginIntent, version, metaname);
        } else {
            /** M: Can not complete for this branch. */
            throw new AndroidException();
        }
