...
public class AudioModel extends MediaModel {
    ...
    public void initModelFromFileUri(Uri uri) throws MmsException {
        ...
        /// M: Add in OP09 Project for 3ga file. @{
        if (mContentType == null && extension.equalsIgnoreCase("3ga")) {
            mContentType = EncapsulatedContentType.AUDIO_3GPP;
            MmsLog.d(TAG, "Set 3GA File with mimetype audio/3gpp");
        }
        /// @}
