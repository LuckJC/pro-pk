...
public class WPMessageListItem extends LinearLayout implements Contact.UpdateListener {
    ...
    private void bindCommonMessage(final WPMessageItem msgItem) {
        ...
        mmsUtilsPlugin.showSimTypeBySimId(this.getContext(), msgItem.mSimId, (TextView) findViewById(R.id.sim_type_conv));
        /// @}
        requestLayout();
    }
    ...
    private CharSequence formatMessage(WPMessageItem msgItem, String contact, String mText, String mURL,
        ...
        if (!TextUtils.isEmpty(mText)) {
            if (IpMessageUtils.getIpMessagePlugin(getContext()).isActualPlugin()
                    && IpMessageUtils.getServiceManager(getContext()).isFeatureSupported(
...
//            mBodyTextView.setTextSize(size);
    ...
    public void onUpdate(Contact updated) {
        ...
        if (!updated.getNumber().equals(mMessageItem.mAddress)) {
            return;
        }
