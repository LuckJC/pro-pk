...
public class SlideEditorActivity extends Activity implements IMmsTextSizeAdjustHost{
    ...
    public static SlideEditorActivity sCurrentActivity;
    // Key for extra data.
    ...
    private final OnClickListener mOnReplaceImage = new OnClickListener() {
        public void onClick(View v) {
            ...
            if (EncapsulatedFeatureOption.MTK_S3D_SUPPORT) {
                intent.putExtra("get_no_stereo_image", true);
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch(requestCode) {
            ...
            case REQUEST_CODE_ATTACH_RINGTONE:
                ...
                if (EncapsulatedSettings.System.DEFAULT_RINGTONE_URI.equals(uri) || uri == null) {
                    break;
                }
            /// @}
                try {
    ...
    */
    ...
    private void showDrmLock() {
        ...
        if (mSlideshowModel.get(mPosition) != null) {
            if (mSlideshowModel.get(mPosition).hasAudio()) {
            ...
            if (mSlideshowModel.get(mPosition).hasVideo()) {
