...
public class MessageListAdapter extends MessageCursorAdapter {
    ...
    private static final String SMS_IP_MESSAGE_ID = EncapsulatedTelephony.Sms.IPMSG_ID;
            ...
            if (type.equals("mms")) {
                ...
                try {
                    item = new MessageItem(mContext, type, c, mColumnsMap, mHighlight, isDrawTimeDivider,
                            isDrawUnreadDivider, unreadCount, isDrawLoadAllMessagesButton, 0L, mIsGroupConversation);
