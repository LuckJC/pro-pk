...
import com.mediatek.encapsulation.android.media.EncapsulatedExifInterface;
...
public class MultiSaveListItemData {
    ...
    private String getSizeFromPart(PduPart part, ContentResolver cr) {
        ...
        if (type.equals(EncapsulatedContentType.TEXT_PLAIN) ||
    ...
    private Bitmap getThumbnailFromPart(PduPart part, Context context, int width, int height) {
        ...
        if (EncapsulatedContentType.isImageType(type)) {
            ...
            try {
                ...
                int degree = 0;
                if (input != null) {
                    EncapsulatedExifInterface exif = new EncapsulatedExifInterface(inputForDegree);
                    if (exif != null) {
            ...
            return thumb;
        } else if (EncapsulatedContentType.isAudioType(type)
