...
import com.mediatek.encapsulation.android.media.EncapsulatedRingtoneManager;
...
public class ChatRingtonePreference extends RingtonePreference {
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
        if (data != null && data.getExtras() != null) {
            int position = data.getExtras().getInt(EncapsulatedRingtoneManager.EXTRA_RINGTONE_PICKED_POSITION);
