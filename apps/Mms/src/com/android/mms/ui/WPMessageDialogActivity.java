...
//        AlertDialog.Builder b = new AlertDialog.Builder(this, AlertDialog.THEME_HOLO_LIGHT);
    ...
    private String getWPMessageDetails(Context context, Intent intent) {
        ...
        int simId = intent.getIntExtra(WapPush.SIM_ID, -1);
        ...
        int expiration = intent.getIntExtra(WapPush.EXPIRATION, 0);
        ...
        if (WapPush.TYPE_SI == type) {
            ...
            switch (priority) {
            case WPMessageActivity.SL_ACTION_LOW:
                details.append(res.getString(R.string.wp_msg_priority_low));
                break;
            case WPMessageActivity.SL_ACTION_HIGH:
                details.append(res.getString(R.string.wp_msg_priority_high));
                break;
            case WPMessageActivity.SL_ACTION_CACHE:
                details.append(res.getString(R.string.wp_msg_priority_low));
                break;
            default:
        ...
        new Thread(new Runnable() {
            public void run() {
                if (mUri != null) {
                    ...
                    WPMessageDialogActivity.this.getContentResolver().update(mUri, values, null, null);
                    WapPushMessagingNotification.blockingUpdateNewMessageIndicator(WPMessageDialogActivity.this,
