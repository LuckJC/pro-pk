    ...
    private void initActivityState(Bundle bundle, Intent intent) {
        ...
        if (threadId > 0) {
            ...
            if (intentData != null) {
                ...
                MmsLog.d(TAG, "Get a conversation based on the intentdata intentData = " + intentData);
        ...
        public void handleMessage(Message msg) {
            ...
            case MessageListItem.ITEM_CLICK: 
                if (mMsgListAdapter.mIsDeleteMode) {
                    ...
                    MmsLog.d(TAG, "On messageListItem click, changeSelectedState msg.arg1 = " + msg.arg1);
                        ...
                        new Thread(new Runnable() {
                            public void run() {
                                ...
                                cursor = getApplicationContext().getContentResolver().query(
                                        EncapsulatedTelephony.SmsCb.CONTENT_URI, new String[] {
                                            "max(_id)"
                                        }, null, null, null);
                                if (cursor != null) {
                                    try {
