                ...
                switch (type) {
                    ...
                    case MESSAGE_TYPE_NOTIFICATION_IND: {
                        ...
                        if (MmsConfig.isSupportCTFeature()) {
                            MessageUtils.dealCTDeviceLowNotification(mContext);
                        }
                        /// M: @}
                        /// M:
                        ...
                        if (!isDuplicateNotification(mContext, nInd)) {
                            ...
                            if (EncapsulatedFeatureOption.MTK_GEMINI_SUPPORT) {
                                ...
                                EncapsulatedSimInfoManager si = EncapsulatedSimInfoManager.getSimInfoBySlot(mContext,
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(WAP_PUSH_DELIVER_ACTION)) {
            Log.v(TAG, "Received PUSH Intent: " + intent + " support WAPPUSH? "
                    + EncapsulatedFeatureOption.MTK_WAPPUSH_SUPPORT);
            ...
            /// @}
            if (EncapsulatedContentType.MMS_MESSAGE.equals(intent.getType())) {
                ...
                if (isWapPushEnabled) {
                    Log.d(TAG, "onReceive WAPPUSH Slot Id = "
                            + Integer.toString(intent.getIntExtra(
                                    EncapsulatedPhone.GEMINI_SIM_ID_KEY, -1), 10) + ", Action = "
                    ...
                    EncapsulatedSimInfoManager simInfo = EncapsulatedSimInfoManager
                            .getSimInfoBySlot(context, slotId);
                    if (null != simInfo) {
