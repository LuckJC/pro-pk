...
public class MessagingNotification {
    ...
    private static final String[] SMS_STATUS_PROJECTION = new String[] {
        ...
        EncapsulatedTelephony.Sms.IPMSG_ID };
    /// @}
    ...
    private static final String NEW_DELIVERY_SM_CONSTRAINT =
        ...
        + " OR " + Sms.STATUS + " = " + EncapsulatedTelephony.Sms.STATUS_REPLACED_BY_SC
    ...
    private static int sSmsUnReadCount = 0;
    /// @}
    ...
    public static void init(Context context) {
        ...
        sMuteModeToneGenerator = new ToneGenerator(AudioManager.STREAM_VOICE_CALL, TONE_FULL_VOLUME);
    }
    ...
    public static void blockingUpdateNewMessageIndicator(Context context, long newMsgThreadId,
        ...
        if (!notificationSet.isEmpty()) {
            ...
            updateNotification(context, newMsgThreadId != THREAD_NONE, threads.size(), notificationSet,
                    newMsgThreadId, notiProf, isContinuousComming);
            sLastNotificationTime = currentTime;
        }
    ...
    private static final void addMmsNotificationInfos(
        ...
        try {
            ...
            sMmsUnReadCount = cursor.getCount();
        } finally {
            cursor.close();
        }
    }
    ...
    private static final void addSmsNotificationInfos(
        ...
        try {
            ...
            sSmsUnReadCount = cursor.getCount();
        } finally {
            cursor.close();
        }
    }
...
//                | Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    private static void updateNotification(
        ...
        int messageCount = 0;
        synchronized (objectLock) {
            messageCount = sMmsUnReadCount + sSmsUnReadCount;
        ...
        if (isNew) {
            ...
            /// M: add for OP09 @{
           // if (MmsConfig.isSupportCTFeature()) {   //gongjh modify 2014/8/15 18:49:19
    ...
    protected static CharSequence buildTickerMessage(
        ...
        if (IpMessageUtils.getServiceManager(context).getIpMessageServiceId() > 0
                && (address.startsWith(IpMessageConsts.GROUP_START) || address.startsWith(IpMessageConsts.JOYN_START))) {
...
//        }
    ...
    private static void playTone(Context context, int tone) {
        ...
        if (EncapsulatedFeatureOption.EVDO_DT_SUPPORT) {
            /// M: Play DTMF tone
                ...
                if ((np.threadMute * 3600 + np.threadMuteStart / 1000) <= currentTime) {
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            values.put(EncapsulatedTelephony.ThreadSettings.MUTE, 0);
                            values.put(EncapsulatedTelephony.ThreadSettings.MUTE_START, 0);
    ...
    private static void wakeUpScreen(Context context) {
       ...
       // if (hasInsertedHeadSet || headsetIsOn) {  //modify by gongjh 2014/8/15 18:49:39
