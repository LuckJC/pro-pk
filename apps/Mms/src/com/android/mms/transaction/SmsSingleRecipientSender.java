...
public class SmsSingleRecipientSender extends SmsMessageSender {
    ...
    public boolean sendMessage(long token) throws MmsException {
        ...
        int slotId = EncapsulatedSimInfoManager.getSlotById(mContext, mSimId);
        ...
        for (int i = 0; i < messageCount; i++) {
            if (mRequestDeliveryReport && (i == (messageCount - 1))) {
                ...
                if (!MmsConfig.isAllowDRWhenRoaming(mContext, slotId)) {
                    MmsLog.d(MmsApp.TXN_TAG, "Disable DR request when roaming!");
