...
public class WapPushMessagingNotification {
    ...
    private static void addWapPushNotificationInfos(
        ...
        if (cursor == null) {
            MmsLog.d(TAG, "addWapPushNotificationInfos cursor == null");
            return;
        }
    ...
    private static void updateNotification(
        ...
        if (isNew) {
            ...
            */
            ...
            String ringtoneStr = notiProf.needMute() ? null : sp.getString(NotificationPreferenceActivity.NOTIFICATION_RINGTONE,
                    null);
    ...
    public static long getWapPushThreadId(Context context, Uri uri) {
        ...
        if (cursor == null) {
            MmsLog.d(TAG, "getWapPushThreadId cursor == null");
            return THREAD_NONE;
        }
    ...
    private static NotificationProfile getNotificationProfile(Context context) {
        return MessagingNotification.getNotificationProfileByThreadId(context, 0);
    }
}
