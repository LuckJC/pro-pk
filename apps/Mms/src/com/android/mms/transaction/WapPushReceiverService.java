...
//        }
    ...
    private void handleWapPushReceived(Intent intent, int error) {
        ...
        String sender = intent.getStringExtra(EncapsulatedTelephony.WapPush.ADDR);
        String serviceCenter = intent.getStringExtra(EncapsulatedTelephony.WapPush.SERVICE_ADDR);
