...
public class MmsSystemEventReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        /// @}
            ...
            if (EncapsulatedPhone.APN_TYPE_MMS.equals(apnType)) {
                ...
                if (EncapsulatedFeatureOption.MTK_GEMINI_SUPPORT) {
                    ...
                    EncapsulatedSimInfoManager si = EncapsulatedSimInfoManager.getSimInfoBySlot(context,
            ...
            sUnreadMessagePlugin = (IUnreadMessageNumber) MmsPluginManager
            ...
            if (unSavedthreadId > 0) {
                ...
                new Thread() {
                    public void run() {
                        ...
                        values.put(EncapsulatedTelephony.ThreadSettings.NOTIFICATION_ENABLE,
        ...
        } else if (action.equals(IStorageLow.ACTION_STORAGE_LOW)) {
        ...
        } else if (action.equals(IStorageLow.ACTION_STORAGE_NOT_LOW) && MmsConfig.isSupportCTFeature()) {
    ...
    public void deleteAttachmentCache(Context c) {
        ...
        File mTempDir = EncapsulatedStorageManager.getExternalCacheDir(c.getPackageName());
