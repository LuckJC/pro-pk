...
import com.mediatek.encapsulation.com.google.android.mms.pdu.EncapsulatedSendConf;
        ...
        try {
            ...
            if (respStatus != PduHeaders.RESPONSE_STATUS_OK) {
                ...
                if (mmsFailedNotifyPlugin.getFailedNotificationEnabled()) {
                    EncodedStringValue encodedValue = new EncapsulatedSendConf(conf).getResponseText();
                    MmsLog.d(MmsApp.TXN_TAG, "Server returned encodedValue: " + encodedValue);
                    if(encodedValue != null) {
                        String respText = encodedValue.getString();
                        MmsLog.d(MmsApp.TXN_TAG, "Server returned Response Text: " + respText);
                        mmsFailedNotifyPlugin.popupToast(IMmsFailedNotify.REQUEST_RESPONSE_TEXT, respText);
                    }
                }
                /** @} */
            ...
            MmsLog.d(MmsApp.TXN_TAG, "SendTransaction: subject is " + (subject == null ? "":subject.getString()));
        } catch (Throwable t) {
