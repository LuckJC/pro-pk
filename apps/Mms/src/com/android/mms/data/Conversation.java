...
public class Conversation {
    ...
    public static final String[] ALL_THREADS_PROJECTION = {
        ...
        EncapsulatedTelephony.ThreadSettings._ID, EncapsulatedTelephony.Threads.DATE_SENT /// M: add for common
    };
    ...
    public static final String[] ALL_THREADS_PROJECTION_EXTEND = {
        ...
        /// M:
        , Threads.TYPE ,EncapsulatedTelephony.Threads.READCOUNT ,EncapsulatedTelephony.Threads.STATUS,
        EncapsulatedTelephony.ThreadSettings._ID, /// M: add for common
        EncapsulatedTelephony.ThreadSettings.NOTIFICATION_ENABLE,
        EncapsulatedTelephony.ThreadSettings.SPAM, EncapsulatedTelephony.ThreadSettings.MUTE,
        EncapsulatedTelephony.Threads.LATEST_IMPORTANT_DATE,
        EncapsulatedTelephony.Threads.LATEST_IMPORTANT_SNIPPET,
        EncapsulatedTelephony.Threads.LATEST_IMPORTANT_SNIPPET_CHARSET,
        EncapsulatedTelephony.ThreadSettings.MUTE_START,
        EncapsulatedTelephony.Threads.DATE_SENT
    };
...
//    private static ContentValues mReadContentValues;
    ...
    ///M: for OP09 date_sent for thread
    private static final int THREAD_DATE_SENT = 20;
    ...
    /// M: OP09 for recording the sent date.
    ...
    public static void startQuery(AsyncQueryHandler handler, int token, String selection) {
            ...
            if (selection != null && selection.equals("allunread")) {
                ...
                handler.startQuery(token, null, sAllThreadsUriExtend, ALL_THREADS_PROJECTION_EXTEND,
...
//                }
    ...
    private static void fillFromCursor(Context context, Conversation conv,
        ...
        synchronized (conv) {
            ...
            /// M: for sent date  ; add in OP09 project As a common function
            conv.mDateSent = c.getLong(THREAD_DATE_SENT);
            ...
            // get unread count
            if (conv.mType == EncapsulatedTelephony.Threads.IP_MESSAGE_GUIDE_THREAD) {
        ...
        if (c.getColumnCount() > SPAM && sIsActivated && recipients.size() == 1) {
            if(IpMessageUtils.getContactManager(context).getIntegrationMode(
                    recipients.get(0).getNumber()) == IpMessageConsts.IntegrationMode.FULLY_INTEGRATED) {
                conv.mIsFullIntegrationMode = true;
            }
            if (conv.mSpamStatus) {
                conv.mSpamDate = IpMessageUtils.getContactManager(context).getSpamTime(recipients.get(0).getNumber());
            }
        }
        /// @}
    }
    ...
    */
    ...
    /**
     * M: return thre sent date; add in OP09 project as a common function
     * @return
     */
    public synchronized long getDateSent() {
        return mDateSent;
    }
