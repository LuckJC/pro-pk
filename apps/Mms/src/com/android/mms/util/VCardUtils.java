...
/// M: Add for OP09, for preview VCard content.
public class VCardUtils {
    ...
    public static int getVCardContactsCount(Context context, Uri dataUri) {
        ...
        try {
            inputStream = context.getContentResolver().openInputStream(dataUri);
            InputStreamReader tmpReader = new InputStreamReader(inputStream, VCardConfig.DEFAULT_INTERMEDIATE_CHARSET);
        ...
        public boolean onElement(EntryElement elem) {
            ...
            if (elem instanceof NameData) {
                ...
                mBuilder.append(mContext.getResources()
                        .getString(com.android.internal.R.string.eventTypeBirthday)).append(STR_COLON)
                ...
                mBuilder.append(mContext.getResources()
                        .getString(com.android.internal.R.string.eventTypeAnniversary)).append(STR_COLON)
