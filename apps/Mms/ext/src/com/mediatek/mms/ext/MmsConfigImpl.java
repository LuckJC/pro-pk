...
import com.mediatek.encapsulation.com.mediatek.common.featureoption.EncapsulatedExtFeatureOption;
...
/// @}
    ...
    public int getSmsToMmsTextThreshold() {
        ...
        if (EncapsulatedExtFeatureOption.EVDO_DT_SUPPORT) {
            MmsLog.d(TAG, "get SmsToMmsTextThreshold For OP09: " + sSmsToMmsTextThresholdForCT);
...
/// @}
    ...
    public boolean isMobileDataEnabled() {
        MmsLog.d(TAG, "isMobileDataEnabled: " + false);
        return false;
    }
    ...
    public boolean isSupportVCardPreview() {
        MmsLog.d(TAG, "isSupportVCardPreview()");
        return false;
    }
    ...
    public boolean isSupportCTFeature(){
        return false;
    }
    ...
    public Uri getUndeliveryMmsQueryUri(Uri defaultUri) {
        MmsLog.d(TAG, "appendExtraQueryParameterForUndeliveryMms");
        return defaultUri;
    }
    /// @}
    ...
    public void setRecipientsEditorOutAtts(EditorInfo outAttrs) {
        MmsLog.d(TAG, "setRecipientsEditorOutAtts");
    }
    /// @}
