...
public interface IMmsDialogMode {

    void init(IMmsDialogModeHost host);
    ...
    boolean updateCTSendButtonStatue(boolean enable);

    String getNotificationContentString(String from, String subject, String msgSizeTxt, String expireTxt);

    void setSimTypeDrawable(Context context, long slotId, TextView textView);
