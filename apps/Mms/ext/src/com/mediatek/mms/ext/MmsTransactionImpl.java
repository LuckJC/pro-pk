...
public class MmsTransactionImpl extends ContextWrapper implements IMmsTransaction {
    ...
    public boolean isGminiMultiTransactionEnabled() {
        MmsLog.d(TAG, "isGminiMultiTransactionEnabled");
        return false;
    }
    /// @}

    /// M: Support retrieve status error check @ {
    public boolean isEnableRetrieveStatusErrorCheck(){
        MmsLog.d(TAG, "Enable Retrieve status error check FALSE");
        return false;
    }
    /// @}
}
