...
public final class IpMessageConsts {
    ...
    /// M: add for ipmessage service center @{
    public static final String IP_MESSAGE_SERVICE_CENTER_NUMBER = "9++99999999";
    public static final long MESSAGE_STATUS_IPSERVICE_CENTER = -10000;
    /// @}
...
//        public static final int STATUS_BLOCKING    = 2;
    ...
    public static final class string {
        ...
        // add for joyn
        public static final int ipmsg_mms_cost_remind               = 281;
        public static final int ipmsg_joyn_cost_remind              = 282;
        public static final int ipmsg_joyn_stranger_remind          = 283;
        public static final int ipmsg_conversation_list_joyn        = 284;
        public static final int ipmsg_conversation_list_xms         = 285;
        public static final int ipmsg_enter_joyn_chat               = 286;
        public static final int ipmsg_enter_xms_chat                = 287;
        public static final int ipmsg_send_by_joyn                  = 288;
        public static final int ipmsg_send_by_xms                   = 289;
        public static final int ipmsg_export_chat                   = 290;
    }
