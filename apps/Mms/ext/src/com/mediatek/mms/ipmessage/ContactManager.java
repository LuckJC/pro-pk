...
public class ContactManager extends ContextWrapper {
    ...
    public boolean isIpMessageSrvNumber(String number) {
        MmsLog.d(TAG, "isIpMessageSrvNumber called");
        return false;
    }

    public String getIpMessageSrvNumberName(String number) {
        MmsLog.d(TAG, "getIpMessageSrvNumberName called");
        return "";
    }

    public boolean isIpMsgSendable(String number) {
        MmsLog.d(TAG, "isIpMsgSendable called");
        return false ;
    }

    public String getUnifyPhoneNumber(String number) {
        MmsLog.d(TAG, "getUnifyPhoneNumber called");
        return "";
    }
    /// @}
}
