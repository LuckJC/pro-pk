...
//    private static final int MSG_FIRST_FRAME_ARRIVED = 14;
    ...
    private Vibrator mVibrator;
		private boolean isSubCameraTest;  //start add by gongjh
...
//                break;
    ...
    private class CameraStartUpThread extends Thread {
        ...
        public void run() {
            ...
            int cameraId = getPreferredCameraId(mPreferences);
      			 System.out.println("mCameraId--1-->"+mCameraId);
            //start add by gongjh for CIT
            if(isSubCameraTest){
            	mCameraId = 1;
            }
            //end add
    ...
    public void onCreate(Bundle icicle) {
        ...
        mCameraId = getPreferredCameraId(mPreferences);
         System.out.println("mCameraId--2-->"+mCameraId);
       //start add by gongjh for CIT
          if(isSubCameraTest){
            	mCameraId = 1;
            }
    ...
    private void screenOnSmartBook() {
        ...
        // add for SMARTBOOK
        try {
            if (FeatureSwitcher.isSmartBookEnabled() && !mHdmiManager.hasCapability(IHDMINative.CAPABILITY_NO_CALL)) {
    ...
    private void doOnResume() {
        ...
        if (isNonePickIntent() || isImageCaptureIntent()) {
        		//edit-s by minesea 2014/7/25 10:52:48 for del show gu
        		/* original codes.
...
//    }
    ...
    private void parseIntent() {
        ...
        String action = intent.getAction();
        isSubCameraTest = intent.getBooleanExtra("is_subcameratest",false);// add by gongjh
