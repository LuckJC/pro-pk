        ...
        if (requestType == MultiChoiceService.TYPE_DELETE) {
            ...
            if (errorCause == ErrorCause.SIM_NOT_READY) {
                ...
                if (ExtensionManager.getInstance().getContactDetailEnhancementExtension()
                    ...
                    notifierFailureSimNotready = R.string.notifier_failure_sim_notready_ct;
                }
                // FOR CT NEW FEATURE CHANGE UIM/SIM STRING START END
                ...
                if (ExtensionManager.getInstance().getContactDetailEnhancementExtension()
                        .isUseOperation(ContactPluginDefault.COMMD_FOR_OP09)) {
                    notifierFailureBySimFull = R.string.notifier_failure_by_sim_full_ct;
                }
                // FOR CT NEW FEATURE CHANGE UIM/SIM STRING START END
