...
public class VoiceSearchDialogFragment extends DialogFragment implements VoiceSearchCircle.CircleDrawListener {
    ...
    private static final int DELAY_SEND_REFRESH_DONE_MGS = 100;
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == MSG_START_SEARCHPANEL) {
                ...
                if (index == mContactsCount - 1) {
                    int delay = VCSUtils.isAnimatorEnable() ? DELAY_SEND_REFRESH_DONE_MGS : 0;
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            //for mSearchPanel
            if (mContactsRowOnClickListener != null && (v == mSearchPanel)) {
                boolean success = mContactsRowOnClickListener.onSearchPanelClick();
                if (!success) {
