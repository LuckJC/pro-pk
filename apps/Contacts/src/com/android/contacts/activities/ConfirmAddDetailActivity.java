...
public class ConfirmAddDetailActivity extends Activity implements
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (ContactsApplication.isContactsApplicationBusy()) {
            LogUtils.i(TAG, "[onCreate]contacts phone book busy.");
       ...
       /** @} */
        ...
        if (mContactUri == null) {
            LogUtils.w(TAG, "[onCreate],mContactUri is null,finish Actviity...");
            setResult(RESULT_CANCELED);
            finish();
        }
    ...
    private void startDisambiguationQuery(String contactDisplayName) {
        ...
        if (TextUtils.isEmpty(contactDisplayName)) {
            LogUtils.w(TAG, "[startDisambiguationQuery],startDisambiguationQuery is null");
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            try {
                ...
                if (ConfirmAddDetailActivity.this.isFinishing()) {
                    LogUtils.w(TAG, "[onQueryComplete],Activity is finishing....");
                    return;
                }
    ...
    private void bindEditor() {
        ...
        if (mIsReadOnly) {
            ...
            showDialogContent();
            LogUtils.i(TAG, "[bindEditor],read only contacts....");
            return;
        }
        ...
        protected Integer doInBackground(RawContactDeltaList... params) {
            ...
            while (tries++ < PERSIST_TRIES) {
                try {
                    ...
                    /** M: Without version column in raw_contact DB when using multi-choice delete. @{ */
    ...
    private void onSaveCompleted(boolean success) {
        LogUtils.i(TAG, "[onSaveCompleted],success:" + success);
        if (success) {
