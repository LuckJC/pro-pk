...
public class AttachPhotoActivity extends ContactsActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (c != null) {
            ...
            Log.e(TAG,"cursor c is null need to check why");
            finish();    
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent result) {
        LogUtils.i(TAG, "[onActivityResult],requestCode:" + requestCode + ",resultCode:" + resultCode + ",result:" + result);
        if (requestCode == REQUEST_PICK_CONTACT) {
            ...
            LogUtils.i(TAG,"[onActivityResult] inputUri:"+inputUri+",toCrop"+toCrop);
    ...
    private void saveContact(Contact contact) {
         ...
         */
        if (deltaList == null) {
            LogUtils.w(TAG, "[saveContact]no writable raw-contact found");
