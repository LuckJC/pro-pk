...
public class PhotoSelectionActivity extends Activity {
    ...
    private void displayPhoto() {
        ...
        /// M: Set the margins of mPhotoView based on the mOriginalPos.
        layoutParams.setMargins(mOriginalPos.left, mOriginalPos.top,
                mBackdrop.getWidth() - mOriginalPos.right,
                mBackdrop.getHeight() - mOriginalPos.bottom);
