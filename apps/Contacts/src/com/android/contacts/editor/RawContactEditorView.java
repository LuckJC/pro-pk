...
//                    showAddInformationPopupWindow();
    ...
    public void setState(RawContactDelta state, AccountType type, ViewIdGenerator vig,
            ...
            for (AccountWithDataSet ads : mAccounts) {
                if (ads instanceof AccountWithDataSetEx) {
                    ...
                    if (ads.name.equals(accountName)) {
                        ...
                        accountDisplayName = simInfo.mDisplayName;
                        /**
                         * M: OP09 icon replace @{
                         */
                        IccCardExtension ext = ExtensionManager.getInstance().getIccCardExtension();
                        getPhotoEditor().setDefaultIconDrawable(
                                ext.getIconDrawableBySimInfoRecord(simInfo, ContactPluginDefault.COMMD_FOR_OP09));
                        /**
                         * M: OP09 icon replace @}
                         */
                    }
        ...
        if (mGroupMembershipKind != null) {
            ...
            //In editor Activity,should disable create group function.
            //otherwise it will cause data corruption.
            //see ALPS00998724
            mGroupMembershipView.enableCreateGroup(false);
