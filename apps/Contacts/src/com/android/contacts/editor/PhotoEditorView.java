...
public class PhotoEditorView extends LinearLayout implements Editor {
    ...
    /**
     * M: set a default icon to the photo editor view, if the icon is not null
     * it will show, otherwise, the default icon will be load via getPhotoImageResource()
     * it's a good way for extend the default icon.
     * 
     * @param iconDrawable
     */
    ...
    /**
     * M: this Drawable has a higher priority to show than the resource getPhotoImageResource()
     * pointed to.
     */
