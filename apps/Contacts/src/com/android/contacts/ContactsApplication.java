...
public final class ContactsApplication extends Application {
    ...
    private static ContactsApplication sMe = null;
    ...
    public void onCreate() {
        ...
        /**
         * M: [Migration] it's the only way by which ContactsCommon can retrieve the application context
         */
        GlobalEnv.setApplicationContext(this);
         ...
         *               which owns to Contacts application.
         */
