...
public class ContactLoaderFragment extends Fragment implements FragmentKeyListener {
    ...
    private final LoaderManager.LoaderCallbacks<Contact> mDetailLoaderListener =
        ...
        public void onLoadFinished(Loader<Contact> loader, Contact data) {
            ///M:check whether the Fragment is also in Activity @{
            if (!isAdded()) {
            ...
            if (data.isError()) {
                ...
                MtkToast.toast(mContext, R.string.generic_failure);
            ...
            if (mListener != null) {
                ...
                LogUtils.w(TAG, "onLoadFinished(),the mListener is null.....");
            }
    ...
    public void onCreateOptionsMenu(Menu menu, final MenuInflater inflater) {
        ...
        if (ContactsFeatureConstants.isSupportBtProfileBpp()) {
            inflater.inflate(R.menu.mtk_view_contact_with_print, menu);
        } else {
            inflater.inflate(R.menu.view_contact, menu);
        }
        /** @} */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_share: {
                 ...
                 */
                /** @} */
                ///M:fix ALPS00876338,add shareUri is just for filer Activity.So when share vcf in FileManager will not 
                ///show  SDcard@{
