...
public class ContactDetailTabCarousel extends HorizontalScrollView implements OnTouchListener {
    ...
    private static final int TAB_INDEX_UPDATES = 2;
    ...
    protected void onFinishInflate() {
        ...
        Log.i("contact tab page", "onFinishInflate-");
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mAllowedHorizontalScrollLength = tabWidth * tabCount - screenWidth
                * (tabWidth * tabCount / screenWidth - 1);
        /// @}
        ...
        if (getChildCount() > 0) {
            ...
            /**
             * M: adjust original code structure For contact detail history feature 
             * Original code:
             *  child.measure(
            ...
            child.measure(
                      MeasureSpec.makeMeasureSpec(
                              tabCount * tabWidth +
                                      (tabCount - 1) * seperatorPixels, MeasureSpec.EXACTLY),
                      MeasureSpec.makeMeasureSpec(tabHeight, MeasureSpec.EXACTLY));
            /** @} */
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        SchedulingUtils.doAfterLayout(this, new Runnable() {
            ...
            public void run() {
                 ...
                 * M: adjust original code structure For contact detail history feature
                 * original code:
                 * scrollTo(mCurrentTab == TAB_INDEX_ABOUT ? 
                 *     0 : mAllowedHorizontalScrollLength, 0);
                 * @{
                 */
                onLayoutSetTab(mCurrentTab);
                /** @}*/
                updateAlphaLayers();
            }
        });
    ...
    public void setCurrentTab(int position) {
        ...
        // extends CarouselTab
        CarouselTab deselected2 = null;
        boolean isCT = ExtensionManager.getInstance()
     ...
     * @{
     */
    protected void onLayoutSetTab(int currentTab) {
        scrollTo(mCurrentTab == 0 ? 0
                : (mCurrentTab == 1 ? (mAllowedHorizontalScrollLength)
                        : mAllowedHorizontalScrollLength * 2), 0);
