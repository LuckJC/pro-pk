...
public class QuickContactListFragment extends Fragment {
    ...
    */
    ...
    /*
     * New Feature by Mediatek Begin. save context's object public
     * QuickContactListFragment() {
     */
    public QuickContactListFragment(Context context,String mimeType) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        mFragmentContainer = (RelativeLayout)inflater.inflate(R.layout.quickcontact_list_fragment,container,false);
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                */
                ...
                if (mimeType.equals(Phone.CONTENT_ITEM_TYPE)) {
                    ...
                    // for CT NEW FEATURE
                    bindCTView(resultView,action.getBody());
                }
    ...
    /**
     * ct NEW FEATURE start
     * @param number 
     */
    private int mInsertedSimCount = SIMInfoWrapper.getDefault().getInsertedSimCount();
    
    private void bindCTView(final View resultView, CharSequence number) {
        if (!TextUtils.isEmpty(number)) {
        	  final String phoneNumber = (String) number;
        
            ExtensionManager.getInstance().getContactDetailEnhancementExtension()
                .bindDetailEnhancementViewForQuickContact(
                        getActivity(),
                        phoneNumber,
                        (ImageView) resultView
                                .findViewById(R.id.first_call_action_button),
                        resultView.findViewById(R.id.vertical_divider_first),
                        (ImageView) resultView
