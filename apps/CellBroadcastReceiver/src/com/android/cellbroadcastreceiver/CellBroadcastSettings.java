...
public class CellBroadcastSettings extends PreferenceActivity {
    ...
    private void initGeminiPreference(Intent it) {
        ...
        if (enableEtwsAlerts != null) {
            String newKey = KEY_ENABLE_ETWS_ALERT + "_"+ mSimId;
        ...
        alertSoundDuration.setDependency(KEY_ENABLE_ETWS_ALERT + "_"+ mSimId);

        // alert reminder interval
        ListPreference reminder = (ListPreference) findPreference(KEY_ALERT_REMINDER_INTERVAL);
        reminder.setKey(KEY_ALERT_REMINDER_INTERVAL + "_" + mSimId);
        ...
        reminder.setValue(prefs.getString(KEY_ALERT_REMINDER_INTERVAL + "_" + mSimId, deafult));
        reminder.setSummary(reminder.getEntry());
        reminder.setDependency(KEY_ENABLE_ETWS_ALERT + "_"+ mSimId);

        CheckBoxPreference alertVibrate = (CheckBoxPreference)findPreference(KEY_ENABLE_ALERT_VIBRATE);
        alertVibrate.setKey(KEY_ENABLE_ALERT_VIBRATE + "_" + mSimId);
        alertVibrate.setChecked(prefs.getBoolean(KEY_ENABLE_ALERT_VIBRATE + "_" + mSimId, true));
        alertVibrate.setDependency(KEY_ENABLE_ETWS_ALERT + "_"+ mSimId);
        ...
        enableAlertSpeech.setDependency(KEY_ENABLE_ETWS_ALERT + "_"+ mSimId);
        ...
        enableEtwsTestAlerts.setDependency(KEY_ENABLE_ETWS_ALERT + "_"+ mSimId);
        ...
        alertVolume.setDependency(KEY_ENABLE_ETWS_ALERT + "_"+ mSimId);
        if(alertVolume != null) {
