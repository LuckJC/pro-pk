...
public class CellBroadcastAlertFullScreen extends Activity {
    private static final String TAG = "[ETWS]CellBroadcastAlertFullScreen";
        ...
        findViewById(R.id.dismissButton).setOnClickListener(
                new Button.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Log.d(TAG, "dismissButton clicked");
                        dismiss(true);
                    }
                });
    ...
    private void updateAlertText(CellBroadcastMessage message) {
        ...
        titleview.setTextColor(-13388315);
        ((TextView) findViewById(R.id.message)).setText(message.getDateString(getApplicationContext())
                + "\n"
        ...
        Log.d(TAG, "updateAlertText queueAlertReminder true simId " + simId);
        CellBroadcastAlertReminder.queueAlertReminder(this, true, simId);
    }
