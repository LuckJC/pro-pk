...
public class CellBroadcastContentProvider extends ContentProvider {
    private static final String TAG = "[ETWS]CellBroadcastContentProvider";
    ...
    public int getUnreadCellBroadcastCount(){
        ...
        Log.i(TAG, "getUnreadCellBroadcastCount return " + count);
        return count;
    }

    public void notifyUnreadCount() {
        Log.i(TAG, "notifyUnreadCount ++");
