...
public class Search {
    ...
    static class SearchParser extends Parser {
        ...
        /// M: To identify the current download results
        private int mCurrentResults;
        ...
        /**
         * M: return the current down load results
         * @return the the current down load results
         */
        protected int getCurrentResults() {
