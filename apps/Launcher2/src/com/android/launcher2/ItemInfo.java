...
public class ItemInfo {
    ...
    ItemInfo(ItemInfo info) {
        /// M: if construct an shortcut from application, set the id to NO_ID first.
        if (info instanceof ApplicationInfo && this instanceof ShortcutInfo) {
            id = NO_ID;
        } else {
            id = info.id;
        }
        ...
        // tempdebug:
        DataUtil.getInstance().checkItemInfo(this);
