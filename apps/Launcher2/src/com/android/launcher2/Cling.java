...
public class Cling extends FrameLayout {
    ...
    private static final String ALLAPPS_PORTRAIT = "all_apps_portrait";
    private static final String ALLAPPS_LANDSCAPE = "all_apps_landscape";
    private static final String ALLAPPS_LARGE = "all_apps_large";
