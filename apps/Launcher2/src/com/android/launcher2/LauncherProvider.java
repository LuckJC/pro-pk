...
public class LauncherProvider extends ContentProvider {
    ...
    private static final String[] DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED_ARRAY =
            {"DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED",
            "DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED2",
            "DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED3"};
    ...
    static String DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED =
            "DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED";
    ...
    public boolean onCreate() {
        ...
        if (FeatureOption.MTK_SMARTBOOK_SUPPORT) {
            ...
            for (int i = 0; i < DATABASE_NUM; ++i) {
                ...
                DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED = DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED_ARRAY[i];
                mDatabaseHelpers.add(new DatabaseHelper(getContext()));
            }
            setDatabaseId(getContext().getResources().getInteger(R.integer.database_id));
        } else {
    ...
    public void setDatabaseId(int id) {
        ...
        DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED = DB_CREATED_BUT_DEFAULT_WORKSPACE_NOT_LOADED_ARRAY[id];
                ...
                while (c.moveToNext()) {
                    ...
                    if (intentDescription != null) {
                        try {
                            ...
                            for (int i = 0; i < MOTA_UPDATE_APPS.size(); i++) {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    if (FeatureOption.MTK_ONLY_OWNER_SIM_SUPPORT) {
                    		if (container == LauncherSettings.Favorites.CONTAINER_HOTSEAT) {
		                        ...
		                        if (userId != UserHandle.USER_OWNER && "com.android.mms".equals(packageName)) {
		                            continue;
		                        }
                      	}
                    }
