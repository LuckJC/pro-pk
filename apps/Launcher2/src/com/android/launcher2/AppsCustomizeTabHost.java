...
public class AppsCustomizeTabHost extends TabHost implements LauncherTransitionable,
    ...
    /// M: the title bar when entering edit mode for op09.
    ...
    protected void onFinishInflate() {
        ...
        /// M: get edit title layout, add for OP09.
        mEditTitleLayout = (LinearLayout) findViewById(R.id.apps_customize_edit_title_layout);
    ...
    public void onLauncherTransitionEnd(Launcher l, boolean animated, boolean toWorkspace) {
        ...
        if (!toWorkspace) {
            ...
            if (LauncherLog.DEBUG) {
                LauncherLog.d(TAG, "[All apps launch time][End] onLauncherTransitionEnd.");
            }
        }
        Trace.traceEnd(Trace.TRACE_TAG_INPUT);
    }
    ...
    public boolean preloadCurrentPage() {
        if(!mAppsCustomizePane.isDataReady()) {
            return false;
        }
        mAppsCustomizePane.loadAssociatedPages(mAppsCustomizePane.getCurrentPage(), true);
        return true;
    ...
    public void enterEditMode() {
        ...
        getTabWidget().setVisibility(View.INVISIBLE);
    ...
    public void exitEditMode() {
        ...
        mEditTitleLayout.setVisibility(View.INVISIBLE);
        mAppsCustomizePane.exitEditMode();
    }

    /**
     * M: whether the given point is within the edit title area, add for OP09.
     *
     * @param x The x-axis of the point.
     * @param y The y-axis of the point.
     * @return True if the point is within the title area, else false.
     */
    public boolean isPointInEditTitleArea(final int x, final int y) {
        final int[] location = new int[2];
        mEditTitleLayout.getLocationOnScreen(location);

        if (x > location[0] && x < location[0] + mEditTitleLayout.getWidth() && y > location[1]
                && y < location[1] + mEditTitleLayout.getHeight()) {
            return true;
        }
        return false;
    }
