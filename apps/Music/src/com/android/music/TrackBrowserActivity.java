...
import android.util.DisplayMetrics;//add by lixd
import android.view.WindowManager;//add by lixd
        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection, DialogInterface.OnClickListener
{
    ...
    public void onResume() {
        ...
        if (mTrackCursor != null) {
            ...
            if (mEditMode) {
                MusicLogUtils.d(TAG, "need to requery data!");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id)
    {
        ...
        MusicLogUtils.i("MusicPerformanceTest", "[CMCC Performance test][Music] play song start ["
            + System.currentTimeMillis() + "]");
