...
// add by puyong@20140918 for "Enable widgets"
...
public class SecuritySettings extends RestrictedSettingsFragment
    ...
    public void onResume() {
        ...
        if (mEnableKeyguardWidgets != null) {
			//add by puyong@20140918 for "Enable widgets"
			SharedPreferences prefs = this.getActivity().getSharedPreferences("EnableKeyguardWidgets", Context.MODE_PRIVATE);
			boolean firstTime = prefs.getBoolean("settings_enable_widgets_first_time", true);

			//Log.d(TAG, "puyong  mEnableKeyguardWidgets   firstTime="+firstTime);

			if (firstTime)
			{
				lockPatternUtils.setWidgetsEnabled(true);
				
				SharedPreferences.Editor pEdit = prefs.edit();
				pEdit.putBoolean("settings_enable_widgets_first_time", false);
				pEdit.commit();
			}
