...
public class LocalAlbumSet extends MediaSet
    ...
    private class AlbumsLoader implements ThreadPool.Job<ArrayList<MediaSet>> {
        ...
        public ArrayList<MediaSet> run(JobContext jc) {
            Trace.traceBegin(Trace.TRACE_TAG_APP, ">>>>LocalAlbumSet-AlbumsLoader");
            ...
            BucketEntry[] entries = BucketHelper.loadBucketEntries(
                    ...
                    mApplication.getResources().getString(R.string.stereo3d_album_name));
    ...
    public synchronized void onFutureDone(Future<ArrayList<MediaSet>> future) {
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                // M: To avoid timing issue of isLoading and notifyContentChanged, set mIsLoading as false here.
                mIsLoading = false;
            }
        });
    }
