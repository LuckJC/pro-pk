...
public class ImageStraighten extends ImageShow {
    ...
    public void setFilterStraightenRepresentation(FilterStraightenRepresentation rep) {
        ...
        /// M: conservative modification to avoid flash when enter straighten panel
        isRepInit = true;
    }
    ...
    public Collection<FilterRepresentation> getFinalRepresentation() {
        ...
        /// M: conservative modification to avoid flash when enter straighten panel
        // a more simple modification is to reset mAngle to be 0 here (without modifying other places)
    ...
    // but I don't want bare the risk of possible side effect (although none in my opinion)
    volatile boolean isRepInit = false;
}
