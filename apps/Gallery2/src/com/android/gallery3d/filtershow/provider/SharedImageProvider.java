...
public class SharedImageProvider extends ContentProvider {
    ...
    /// M: because Bluetooth can call query() direct, so we init mImageReadyCond state to open default
    private static ConditionVariable mImageReadyCond = new ConditionVariable(true);
