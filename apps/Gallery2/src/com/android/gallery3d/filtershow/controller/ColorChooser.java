...
public class ColorChooser implements Control {
    ...
    public void setUp(ViewGroup container, Parameter parameter, Editor editor) {
        ...
        for (int i = 0; i < mButtonsID.length; i++) {
            ...
            /// M: when user select color from MenuItem, we need reset the color value  
    ...
    public void changeSelectedColor(float[] hsvo) {
        ...
        /// M: if user not choose any color, should set origin color to color button
        ...
        //M: c == Color.HSVToColor((int) (hsvo[OPACITY_OFFSET] * 255), hsvo), so we can replace it 
