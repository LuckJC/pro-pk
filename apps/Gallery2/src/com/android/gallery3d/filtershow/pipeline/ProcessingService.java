...
public class ProcessingService extends Service {
    ...
    private void tearDownPipeline() {
        ...
        /// M: free all filter resources when destroying @{
        FiltersManager.getPreviewManager().FinalizeFilterResources();
        FiltersManager.getManager().FinalizeFilterResources();
        FiltersManager.getHighresManager().FinalizeFilterResources();
        /// @}
