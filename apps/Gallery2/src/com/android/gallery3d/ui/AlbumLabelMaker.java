...
public class AlbumLabelMaker {
    ...
    private class AlbumLabelJob implements ThreadPool.Job<Bitmap> {
        ...
        public Bitmap run(JobContext jc) {
            MtkUtils.traceStart("AlbumLabelMaker:AlbumLabelJob.run");
            Trace.traceBegin(Trace.TRACE_TAG_APP, ">>>>AlbumLabelMaker-AlbumLabelJob.run");
            ...
            if (jc.isCancelled()) {
                ...
                MtkUtils.traceEnd("AlbumLabelMaker:AlbumLabelJob.run");
                return null;
            }
