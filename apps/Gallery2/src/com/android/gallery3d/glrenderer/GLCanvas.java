...
public interface GLCanvas {
    ...
    void setSize(int x, int y, int width, int height, int viewWidth, int viewHeight);
    ...
    // M: add for S3D @{
    public abstract void saveScissorBox();
    public abstract void restoreScissorBox();
    public abstract void setScissorBox(int x, int y, int width, int height);
    // @}
    ...
    public abstract void drawMesh(BasicTexture tex, float degree, float x, float y, float z,
