...
public class GLES11Canvas implements GLCanvas {
    ...
    public void setSize(int x, int y, int width, int height,
        ...
        gl.glMatrixMode(GL11.GL_PROJECTION);
        gl.glLoadIdentity();
        GLU.gluOrtho2D(gl, x, x + width, bottom, bottom + height);
    ...
    ///add for camera launch performance @{
    ...
    public void saveScissorBox() {
        mGL.glGetIntegerv(GL11.GL_SCISSOR_BOX, mTempScissorBox, 0);
    }
    
    @Override
    public void restoreScissorBox() {
        mGL.glScissor(mTempScissorBox[0], mTempScissorBox[1], 
