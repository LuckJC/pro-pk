...
public class StateManager {
    ...
    public void startState(Class<? extends ActivityState> klass,
            Bundle data) {
        MtkUtils.traceStart("StateManager:startState");
        ...
        MtkUtils.traceEnd("StateManager:startState");
    }
    ...
    public void resume() {
        MtkUtils.traceStart("StateManager:resume");
    ...
    void finishState(ActivityState state, boolean fireOnPause) {
        ...
        if (mStack.size() == 1) {
            ...
            ///M:size is zero, not need finish
            return;
        }
