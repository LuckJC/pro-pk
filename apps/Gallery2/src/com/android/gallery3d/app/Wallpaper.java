...
public class Wallpaper extends Activity {
    ...
    protected void onResume() {
        ...
        switch (mState) {
            ...
            case STATE_PHOTO_PICKED: {
                ...
                ///M: while use launcher3,should start Google default wallpaper activity,which do not support GIF format.
                // So only use the Gallery CropImage for setting wallpaper.
    ...
    private boolean startMtkCropFlow() {
        ...
        request.putExtra(CropExtras.KEY_OUTPUT_X, width)
                .putExtra(CropExtras.KEY_OUTPUT_Y, height)
                .putExtra(CropExtras.KEY_ASPECT_X, width)
                .putExtra(CropExtras.KEY_ASPECT_Y, height)
                .putExtra(CropExtras.KEY_SPOTLIGHT_X, spotlightX)
                ...
                //.putExtra(CropExtras.KEY_NO_FACE_DETECTION, true)
                .putExtra(CropExtras.KEY_SET_AS_WALLPAPER, true)
                .putExtra(GalleryActivity.EXTRA_CROP, EXTRA_CROP_FOR_WALLPAPER);
