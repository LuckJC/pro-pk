...
/*      new ActionItem(FilterUtils.CLUSTER_BY_FACE, true, false, R.string.people,
    ...
    public void setShareActionProviderListener(OnShareTargetSelectedListener listener) {
    ...
    /// M: need to remove AlbumModeListener if doCluster in AlbumSetPage. @{
    public void removeAlbumModeListener() {
        if (mActionBar != null) {
            mAlbumModeListener = null;
            Log.i(TAG, "ActionBar: removeAlbumModeListener to doCluster");
        }
    }
    /// @}
    /// M: added for ConShots
    // replace ActionBar Icon with ConShots Icon
