...
public class ExtensionHelper {
    ...
    public static IActivityHooker getHooker(final Context context) {
        ...
        if (com.mediatek.common.featureoption.FeatureOption.MTK_SLOW_MOTION_VIDEO_SUPPORT) {
            group.addHooker(new SlowMotionHooker());
        }
        group.addHooker(new TrimVideoHooker());
/*        if(MovieUtils.isSupportTrim(context,((MovieActivity)context).getIntent().getData())) {
            group.addHooker(new TrimVideoHooker());
        }  */
        ...
        if (MtkUtils.isClearMotionSupport()) {
