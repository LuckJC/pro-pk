...
/**
 * 
 * the hooker class for menu list
 * @author MTK40641
 *
 */
public class SubtitleVideoHooker extends MovieHooker{
	 ...
	 private MenuItem mMenuSubtitleSetButton;
	    ...
	    public boolean onCreateOptionsMenu(final Menu menu) {
	        ...
	        mMenuSubtitleSetButton = menu.add(0, getMenuActivityId(MENU_SUBTITLE_SETTING), 0, R.string.SubtitleSetting);
	        return true;
	    }
	    @Override
