...
public class SubtitleSettingDialog extends AlertDialog implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mView = getLayoutInflater().inflate(R.layout.subtitle_setting_dialog,
				null);
		if (mView != null) {
			setView(mView);
		}
		...
		inflater_tab.inflate(R.layout.subtitle_setting_text, mTabHost
				.getTabContentView());
		getLayoutInflater().inflate(R.layout.subtitle_setting_layout,
