...
public class PanoramaConfig {
    private static final String TAG = "Gallery2/PanoramaConfig";
    ...
    public PanoramaConfig(int imageWidth, int imageHeight, int canvasWidth, int canvasHeight) {
        this(imageWidth, imageHeight, canvasWidth, canvasHeight,
                PanoramaHelper.SCREENNAIL_ANTIALIAS_SCALE);
    }
    ...
    private void print() {
        MtkLog.i(TAG, "originW = " + mOriginWidth + 
