...
public interface IActivityHooker {
    ...
    /**
     * Will be called in Host Activity.onBackPressed. If back key message
     * is consumed(completely processed), return true, else return false
     * @return
     */
    boolean onBackPressed();
    /**
     * Will be called in Host Activity.onConfigurationChanged. ActivityHooker
     * should adjust configuration if needed
     * @param newConfig
     */
    ...
    /**
     * Host activity will call this function to detect if there is some layout
     * over covered on video. True for covered case, and false for un-covered case
     * @return
     */
    boolean isPartialVisible();
}
