...
public class SoundRecorderService extends Service implements Player.PlayerListener,
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (action.equals(ACTION_GOON_RECORD) && mCurrentState == STATE_PAUSE_RECORDING) {
            ...
            startRecordingAsync(mCurrentRecordParams, 0);
    ...
    public void onScanCompleted(String path, Uri uri) {
        ...
        //edit-s by leihai 2013/10/29 15:55:32 for sound title
        /* original codes.
        String title = simpleDateFormat.format(date);
        */
        int separatorIndex = path.lastIndexOf("/");
    		String title= (separatorIndex < 0) ? path : path.substring(separatorIndex + 1, path.length());
    		//edit-e by leihai 2013/10/29 15:55:32 for sound title
    ...
    public void startRecordingAsync(RecordParams recordParams, int fileSizeLimit) {
