    ...
    public void setSearchEngineInfo(String favicon) {
        try {
            ...
            if (mSearchEngineInfo != null) {
                oldFavicon = mSearchEngineInfo.getFaviconUri();
            }
            ...
            if (searchEngineManager != null) {
                mSearchEngineInfo = searchEngineManager
                        .getBestMatchSearchEngine("", favicon) != null ? searchEngineManager
                        .getBestMatchSearchEngine("", favicon)
                        : searchEngineManager.getDefaultSearchEngine();
            } else {
                Log.d(TAG, "setSearchEngineInfo(), get SEARCH_ENGINE_SERVICE failed.");
            }

            // update SharedPreferences
            String currentfavicon = "";
            if (mSearchEngineInfo != null) {
                currentfavicon = mSearchEngineInfo.getFaviconUri();
            }
