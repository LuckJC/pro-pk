...
public class SearchableSources implements Sources {
    ...
    private void addSearchableSources() {
        ...
        if (searchables == null) {
            Log.e(TAG, "addSearchableSources(), getSearchablesInGlobalSearch() returned null");
            return;
        }
        ...
        for (SearchableInfo searchable : searchables) {
            ...
            if (FeatureOption.MTK_ONLY_OWNER_SIM_SUPPORT) {
                ...
                String searchActivity = searchable.getSearchActivity().getPackageName();
                if (userId != UserHandle.USER_OWNER) {
                    if (searchActivity != null && searchActivity.equals("com.android.mms")) {
                        continue;
                    }
                }
            }
        ...
        Log.d(TAG, "addSearchableSources(), searchables got from SearchManager: " + searchables.size());
        Log.d(TAG, "addSearchableSources(), searchables added: " + mSources.size());
    }
