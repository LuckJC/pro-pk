...
public class SearchSettingsImpl implements SearchSettings {
    ...
    public String getDefaultSearchEngineFavicon() {
        Log.d(TAG, "getDefaultSearchEngineFavicon().");
        ...
        if (searchEngineManager == null) {
            Log.d(TAG, "getDefaultSearchEngineFavicon(), get SEARCH_ENGINE_SERVICE failed.");
            return "";
        }

        SearchEngineInfo temp = searchEngineManager.getDefaultSearchEngine();
        if (temp == null) {
            Log.d(TAG, "getDefaultSearchEngineFavicon(), getDefaultSearchEngine is null.");
            return "";
        }

        String favicon = temp.getFaviconUri();
        try {
