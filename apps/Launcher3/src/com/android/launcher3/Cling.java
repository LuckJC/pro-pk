...
public class Cling extends FrameLayout implements Insettable, View.OnClickListener,
    ...
    private static float WORKSPACE_INNER_CIRCLE_RADIUS_DPS = 100;
    private static float WORKSPACE_OUTER_CIRCLE_RADIUS_DPS = 120;
    private static float WORKSPACE_CIRCLE_Y_OFFSET_DPS = 20;
