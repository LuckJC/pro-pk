...
import com.mediatek.calendar.lunar.date.LunarSimpleMonthView.OnDayClickListener;
...
public class LunarSimpleMonthAdapter extends BaseAdapter implements OnDayClickListener {
     ...
     */
    public static class CalendarDay extends com.android.datetimepicker.date.SimpleMonthAdapter.CalendarDay {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            v = new LunarSimpleMonthView(mContext);
            // Set up the new view
