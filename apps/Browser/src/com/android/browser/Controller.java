...
/*
    ...
    public void onPageStarted(Tab tab, WebView view, Bitmap favicon) {
        Xlog.i(LOGTAG, "onPageStarted start");
        ...
        Xlog.i(LOGTAG, "onPageStarted end");
    }

    @Override
    public void onPageFinished(Tab tab) {
        Xlog.i(LOGTAG, "onPageFinished start");
        ...
        Xlog.i(LOGTAG, "onPageFinished end");
    }

    @Override
    public void onProgressChanged(Tab tab) {
        Xlog.i(LOGTAG, "onProgressChanged");
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        DownloadHandler.onDownloadStartNoStream(activity, downloadUrl, downloadUserAgent,
                                            downloadContentDisposition, downloadMimetype, null, downloadView.isPrivateBrowsingEnabled(), downloadContentLength);
                                        Xlog.d(XLOGTAG, "User decide to download the content");
                                        if (downloadView != null && downloadView.copyBackForwardList().getSize() == 0) {
                                            // This Tab was opened for the sole purpose of downloading a
                                            // file. Remove it.
    ...
    public void setActiveTab(Tab tab) {
        ...
        if (tab != null) {
            ...
            if (BrowserFeatureOption.BROWSER_SMARTBOOK_SUPPORT) {
                ...
                Xlog.i(LOGTAG, "set active tab, get the smart book plugged: " + mIsSmartBookPlugged);
