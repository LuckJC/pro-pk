...
public class BrowserProvider2 extends SQLiteContentProvider implements IBrowserProvider2Ex {
    ...
    public int addDefaultBookmarksHost(SQLiteDatabase db, long parentId, 
        ...
        case 2:
            ...
            break;
        case 3:
            preloads = getContext().getResources().obtainTypedArray(R.array.bookmark_preloads_for_op03);
            position = mOpenHelper.addDefaultBookmarks(db, parentId, bookmarks, preloads, position);
            Xlog.i(XLOGTAG, "position: " + position);
            break;
        case 9:
            preloads = getContext().getResources().obtainTypedArray(R.array.bookmark_preloads_for_op09);
            position = mOpenHelper.addDefaultBookmarks(db, parentId, bookmarks, preloads, position);
            break;			
        default:
            break;
        ...
        if (TextUtils.isEmpty(selectionArgs[0])) {
            ...
            if (selectionArgs[0].startsWith("http")
                ...
                selection = "url LIKE ? OR url LIKE ? OR url LIKE ? OR url LIKE ?"
                    + " OR title LIKE ?";
                Xlog.i(XLOGTAG, "doSuggestQuery, selectionArgs: " + selectionArgs);
                ...
                Xlog.i(XLOGTAG, "doSuggestQuery, getCount: " + sc.getCount());
                return sc;
            }
        }
